...
; ripped from the ROMs and put in clear here for future
; reference
;
; only the 7 first values are used
; end values aren't used? or used on round 2 when all events
; are completed? also note how the 240kg, 260kg of weightlifting
; are common with the 2400, 2600 points on archery!

qualifying_values_table_d79b:
	.word  triple_jump_d7a9,skeet_d7bd,pole_vault_d7d1,freestyle_d7e3,weightlifting_d7f8,archery_d804,long_horse_d818

triple_jump_d7a9:
	.byte	0x12,0x00,0x14,0x00,0x14,0x50,0x15,0x00,0x15,0x50,0x16,0x00,0x17,0x00,0x18,0x00
	.byte	0x19,0x00,0x13,0x00
skeet_d7bd:
	.byte	0x10,0x00,0x15,0x00,0x20,0x00,0x30,0x00,0x34,0x00,0x35,0x00,0x40,0x00
	.byte	0x42,0x00,0x46,0x00,0x48,0x00
pole_vault_d7d1:
	.byte	0x05,0x70,0x05,0x75,0x05,0x80,0x05,0x85,0x05,0x86,0x05,0x88,0x05,0x90,0x05,0x95
	.byte	0x05,0x65	
freestyle_d7e3:
	.byte	0x02,0x00,0x00		; easy
	.byte	0x01,0x20,0x00		; medium
	.byte	0x01,0x00,0x00		; super difficult
	.byte 	0x00,0x58,0x00		; the other values? for round 2?
	.byte 	0x00,0x55,0x00
	.byte	0x00,0x50,0x00
	.byte	0x00,0x45,0x00
weightlifting_d7f8:
	.byte	0x15,0x00,0x16,0x50,0x18,0x00,0x19,0x50,0x21,0x00,0x22,0x50, ...
	;.byte	0x24,0x00,0x26,0x00  ; reuses 2400,2600 from archery below!
archery_d804:
	.byte    0x24,0x00,0x26,0x00,0x28,0x00,0x30,0x00,0x32,0x00,0x33,0x00,0x34,0x00,0x36,0x00
	.byte	 0x38,0x00,0x42,0x00
long_horse_d818:
	.byte	0x08,0x80,0x08,0x90,0x09,0x00,0x09,0x10,0x09,0x20,0x09,0x30,0x09,0x40,0x09,0x50,0x09,0x60,0x09,0x80
