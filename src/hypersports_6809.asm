...
406C: 9F 14          STX    $3C
406E: 9F B6          STX    $3E
4070: B6 34 01       LDA    $1683
4073: 43             COMA
4074: 97 2E          STA    $0C
4076: B6 94 28       LDA    $1600
4079: 43             COMA
...
421D: 27 84          BEQ    $422B
421F: 96 B3          LDA    $91
4221: A7 4B 8A 22    STA    $0800,U
4225: C0 B2          SUBB   #$30
4227: E7 E8          STB    ,U+
4229: 20 66          BRA    $4219
422B: 39             RTS
422C: 5F             CLRB
422D: E7 41 80 22    STB    $0800,U
4231: A7 42          STA    ,U+
4233: 39             RTS
...
452D: 0A C0          DEC    $48
452F: 26 D0          BNE    $4523
4531: B6 94 02       LDA    $1680
4534: 43             COMA
4535: 97 92          STA    $10
4537: B6 3E A9       LDA    $1681
453A: 43             COMA
453B: 97 3B          STA    $13
453D: B6 9E 0A       LDA    $1682
4540: 43             COMA
4541: 97 94          STA    $16
4543: 39             RTS
4544: 96 2E          LDA    $0C
...
4555: 0A 86          DEC    $04
4557: 86 29          LDA    #$01
4559: B7 9C 0B       STA    $1483
455C: 96 2E          LDA    $06
455E: 27 8C          BEQ    $4564
4560: 0A 24          DEC    $06
4562: 86 83          LDA    #$01
4564: B7 36 06       STA    $1484
4567: 96 3A          LDA    $12
4569: 9A 99          ORA    $11
456B: 43             COMA
456C: 94 38          ANDA   $10
...
45DA: 39             RTS
45DB: A6 A8          LDA    ,X+
45DD: B7 9D 88       STA    $1500
45E0: 4F             CLRA
45E1: B7 96 03       STA    $1481
45E4: 12             NOP
45E5: 12             NOP
45E6: 12             NOP
45E7: 12             NOP
45E8: 4C             INCA
45E9: B7 9C 09       STA    $1481
...
584E: E7 41 2A 22    STB    $0800,U
5852: A7 42          STA    ,U+
5854: 39             RTS
5855: CE A4 C1       LDU    #$2643
5858: 86 38          LDA    #$10
585A: C6 8C          LDB    #$04
585C: 6F E1 80 88    CLR    $0800,U
5860: A7 E6          STA    ,U
...
7C7C: D7 65          STB    $4D
7C7E: D6 C2          LDB    $4A
7C80: E7 EB 8A 82    STB    $0800,U
7C84: A7 E2          STA    ,U+
7C86: 0A CF          DEC    $4D
7C88: 26 DE          BNE    $7C80
7C8A: 39             RTS
7C8B: D6 62          LDB    $4A
7C8D: E7 41 80 22    STB    $0800,U
7C91: A7 46          STA    ,U
...
7FDF: 77 DD DD       ASR    $FFFF
7FE2: 7D 7D DD       TST    $FFFF
7FE5: DD 7D          STD    $FF
7FE7: 7D D7 D7       TST    $FFFF
7FEA: 77 77 D7       ASR    $FFFF
7FED: D7 77          STB    $FF
7FEF: 77 DD DD       ASR    $FFFF
7FF2: 7D 7D DD       TST    $FFFF
7FF5: DD 7D          STD    $FF
7FF7: 7D D7 D7       TST    $FFFF
7FFA: 77 77 D7       ASR    $FFFF
7FFD: D7 77          STB    $FF
7FFF: 77 96 4B       ASR    $B469
8002: 81 82          CMPA   #$00
8004: 26 31          BNE    $8019
...
98AD: E7 01 80 22    STB    $0800,X
98B1: E7 0B 8A 23    STB    $0801,X
...
9BFE: 26 8A          BNE    $9C02
9C00: 86 32          LDA    #$10
9C02: 6F 0B 2A 22    CLR    $0800,X
9C06: A7 02          STA    ,X+
9C08: A6 E8          LDA    ,U+
9C0A: 6F 01 20 28    CLR    $0800,X
9C0E: A7 08          STA    ,X+
9C10: 86 09          LDA    #$2B
9C12: 6F 0B 2A 22    CLR    $0800,X
9C16: A7 02          STA    ,X+
9C18: A6 E8          LDA    ,U+
9C1A: 6F 01 20 28    CLR    $0800,X
9C1E: A7 0C          STA    ,X
9C20: 0D 53          TST    $71
9C22: 27 90          BEQ    $9C36
9C24: 0A 53          DEC    $71
...
A156: 12             NOP           ; bootleg_hack  LDA    $1680
A157: 12             NOP
A158: 12             NOP
A159: 12             NOP
A15A: 12             NOP
...
A194: E7 AB 8A 82    STB    $0800,X
A198: A7 A8          STA    ,X+
A19A: A6 48          LDA    ,U+
A19C: BD BD E4       JSR    $956C
A19F: E7 AB 2A 82    STB    $0800,X
A1A3: A7 A2          STA    ,X+
A1A5: 0A D3          DEC    $51
A1A7: 26 CA          BNE    $A18B
A1A9: 6F 0C          CLR    ,X
A1AB: E7 A1 20 88    STB    $0800,X
A1AF: 30 37          LEAX   -$B,X
A1B1: 86 81          LDA    #$03
A1B3: 97 6A          STA    $48
A1B5: 1F 1A          TFR    B,A
...
A7CA: ED 21 2F D6    STD    $07FE,Y
A7CE: ED 21 2A 22    STD    $0800,Y
...
B9A7: E7 AC          STB    ,X
B9A9: A7 01 80 28    STA    $0800,X
B9AD: E7 00 48       STB    -$40,X
B9B0: A7 AB 85 42    STA    $07C0,X
B9B4: E7 AA 02       STB    -$80,X
B9B7: A7 A1 2F 08    STA    $0780,X
B9BB: 39             RTS
...
BFEA: 77 77 D7       ASR    $FFFF
BFED: D7 77          STB    $FF
BFEF: 77 DD DD       ASR    $FFFF
BFF2: 7D 7D DD       TST    $FFFF
BFF5: DD 7D          STD    $FF
BFF7: 7D D7 D7       TST    $FFFF
BFFA: 77 77 D7       ASR    $FFFF
BFFD: D7 77          STB    $FF
BFFF: 77 86 24       ASR    $A406
C002: 9B F0          ADDA   $72
C004: 19             DAA
C005: 97 F0          STA    $72
C007: 24 3C          BCC    $C01D
...
CF12: 39             RTS
CF13: 7D DD DD       TST    $FFFF
CF16: 7D 7D D7       TST    $FFFF
CF19: D7 77          STB    $FF
CF1B: 77 D7 D7       ASR    $FFFF
CF1E: 77 77 DD       ASR    $FFFF
CF21: DD 7D          STD    $FF
CF23: 7D DD DD       TST    $FFFF
CF26: 7D 7D D7       TST    $FFFF
CF29: D7 77          STB    $FF
CF2B: 77 D7 D7       ASR    $FFFF
CF2E: 77 77 63       ASR    $FF41
CF31: F2 C0 8C       SBCB   $420E
CF34: 60 33          NEG    -$F,X
CF36: C0 B6          SUBB   #$34
CF38: 6A 8A          DEC    ,-Y
CF3A: CA 48          ORB    #$C0
CF3C: 6B 08          XDEC   $0,Y
CF3E: CC F8 23       LDD    #$7001
CF41: 23 83          BLS    $CF44
CF43: 80 23          SUBA   #$01
CF45: 21 83          BRN    $CF48
CF47: 86 29          LDA    #$01
CF49: 2D 89          BLT    $CF4C
CF4B: 8E 29 2F       LDX    #$0107
CF4E: 8A 89          ORA    #$01
CF50: 20 21          BRA    $CF55
CF52: 80 87          SUBA   #$05
CF54: 21 23          BRN    $CF57
...
CF76: 81 80          CMPA   #$02
CF78: 2B 2C          BMI    $CF7E
CF7A: 8C 89 2C       CMPX   #$0104
CF7D: 2B 89          BMI    $CF80
CF7F: 88 34          EORA   #$16
CF81: 5B             XDECB
CF82: 94 C0          ANDA   $42
CF84: 37 AA          PULU   DP,PC
CF86: B2 82 0F       SBCA   >$0027
CF89: 28 AE          BVC    $CFB1
CF8B: 88 2D          EORA   #$05
CF8D: AD 8D          JSR    $5,X
CF8F: 08 27          ASL    $05
...
CFA1: 22 B3          BHI    $CFD4
CFA3: A2 2B          SBCA   $9,X
CFA5: 72 8B C7       XNC    $0945
CFA8: 21 68          BRN    $CFEA
CFAA: C8 C8          EORB   #$40
CFAC: 79 7D C9       ROL    $5541
CFAF: C4 6B          ANDB   #$49
CFB1: 64 DB          LSR    -$7,U
CFB3: C2 6B          SBCB   #$49
CFB5: 71 C2 C6       NEG    $4044
CFB8: 61 78          NEG    -$10,U
CFBA: C8 DB          EORB   #$53
CFBC: 7F 68 C8       CLR    $4040
CFBF: C8 73          EORB   #$51
CFC1: 77 C3 CE       ASR    $414C
CFC4: 6B 64          XDEC   $6,U
CFC6: DB C2          ADDB   $40
CFC8: 61 7B          NEG    -$D,U
CFCA: C8 CA          EORB   #$42
CFCC: 69 6B          ROL    $3,U
CFCE: C3 C8 77       ADDD   #$4055
CFD1: 72 C2 D0       XNC    $4052
CFD4: 63 6F          COM    $D,U
CFD6: 91 A2          CMPA   $20
CFD8: 0D 2A          TST    $02
CFDA: 8D 8F          BSR    $CFE3
...
CFDE: 84 85          ANDA   #$0D
CFE0: 2C 2D          BGE    $CFF1
CFE2: 8E 8F 2C       LDX    #$0D0E
CFE5: 23 88          BLS    $CFF1
CFE7: 81 20          CMPA   #$08
CFE9: F8 ED 58       EORB   $65D0
CFEC: 58             ASLB
CFED: F8 F3 58       EORB   $7BD0
CFF0: A4 F2          ANDA   [,W++]
CFF2: 13             SYNC
CFF3: 52             XNCB
CFF4: B8 F2 2B       EORA   $D0A9
CFF7: 52             XNCB
CFF8: 9F F8          STX    $D0
CFFA: 37 58          PULU   X,S,PC
CFFC: EF F8          STU    [,W++]
CFFE: 47             ASRA
CFFF: 58             ASLB
D000: F4 F2 5F       ANDB   $D0DD
D003: 52             XNCB
D004: CE F3 8D       LDU    #$D10F
D007: 53             COMB
D008: 3B             RTI
D009: F9 94 59       ADCB   $1CD1
D00C: 0E F9          JMP    $D1
D00E: A7 59          STA    [,U++]
D010: 1D             SEX
D011: F3 D3 53       ADDD   $51D1
D014: 78 F3 EE       ASL    $D16C
D017: 53             COMB
D018: A9 F9          ADCA   [,U++]
D01A: 10 59          ROLB
D01C: 87 F9          XSTA   #$D1
...
D026: 52             XNCB
D027: 53             COMB
D028: F0 F9 6A       SUBB   $D1E2
D02B: 59             ROLB
D02C: C4 F9          ANDB   #$D1
D02E: 72 5A 2B       XNC    $D209
D031: F0 A6 50       SUBB   $24D2
D034: 1B             NOP
D035: F0 BD 50       SUBB   $3FD2
D038: 6D FA          TST    Illegal Postbyte
D03A: C3 5A 7F       ADDD   #$D257
D03D: FA EA 5A       ORB    $62D2
D040: 4F             CLRA
D041: F0 FA 50       SUBB   $78D2
D044: A1 F0          CMPA   Illegal Postbyte
D046: 09 50          ROL    $D2
D048: B7 FA 3E       STA    $D2B6
D04B: 5A             DECB
D04C: E1 FA          CMPB   Illegal Postbyte
D04E: 6A 5A          DEC    Illegal Postbyte
D050: DB F1          ADDB   $D3
D052: 8B 51          ADDA   #$D3
D054: 3E             XRES
D055: F1 A0 51       CMPB   $22D3
D058: 00 FB          NEG    $D3
D05A: A6 5B          LDA    [,--U]
D05C: 06 F8          ROR    $D0
D05E: 64 59          LSR    [,U++]
...
D068: 64 69          LSR    $1,U
D06A: D1 CD          CMPB   $45
D06C: 7A 68 B9       DEC    $4031
D06F: B7 00 68       STA    $224A
D072: D2 CE          SBCB   $4C
D074: 63 7B          COM    -$7,U
D076: C7 D0          XSTB   #$52
D078: 68 1A          ASL    -$E,Y
D07A: B7 AA 62       STA    $224A
D07D: 78 C4 C9       ASL    $4C41
D080: 7B 67 D0       XDEC   $4552
D083: C2 11          SBCB   #$33
D085: 1D             SEX
D086: A0 C8          SUBA   $A,U
D088: 78 64 C9       ASL    $4C41
D08B: D1 6D          CMPB   $45
D08D: 7A C8 BC       DEC    $4034
D090: 1D             SEX
D091: 05 94          LSR    $16
D093: C1 70          CMPB   #$52
D095: 67 C6          ASR    $4,U
D097: CB 7C          ADDB   #$54
D099: 17 AA 42       LBSR   $F366
D09C: 68 6F          ASL    $7,U
D09E: C9 C5          ADCB   #$4D
D0A0: 67 62          ASR    $0,U
D0A2: C2 CD          SBCB   #$4F
D0A4: 74 67 D0       LSR    $4552
D0A7: C2 17          SBCB   #$3F
D0A9: 0C 42          INC    $CA
D0AB: D8 7A          EORB   $52
D0AD: 6D DB          TST    -$D,U
D0AF: DB 62          ADDB   $40
D0B1: 71 D6 C3       NEG    $5441
D0B4: 70 76 BD       NEG    $543F
D0B7: A0 E5 7A CD    SUBA   $12300,PCR
D0BB: C9 6C          ADCB   #$44
D0BD: 71 B7 AC       NEG    $3F24
D0C0: 20 62          BRA    $D102
D0C2: C5 C3          BITB   #$41
D0C4: 6F 67          CLR    $5,U
D0C6: BD A6 6D       JSR    $2445
D0C9: 67 DE          ASR    -$A,U
D0CB: CD             XHCF
D0CC: 7A 68 B7       DEC    $403F
D0CF: A9 29          ADCA   $B,X
D0D1: 65 C3          LSR    $1,U
D0D3: CF 67 1D       XSTU   #$453F
D0D6: A3 09          SUBD   D,X
D0D8: 67 7E          ASR    -$A,U
D0DA: CD             XHCF
D0DB: DA 17          ORB    $3F
D0DD: 0E 02          JMP    $8A
D0DF: B2 69 6D       SBCA   $4B4F
D0E2: CC C3 6F       LDD    #$414D
D0E5: 6B C2          XDEC   $0,U
D0E7: B3 11 10       SUBD   $3938
D0EA: BC B7 0A       CMPX   $3F22
D0ED: 88 C8          EORA   #$40
D0EF: C8 62          EORB   #$40
D0F1: 62 C2          XNC    $0,U
D0F3: C2 88          SBCB   #$AA
...
D10B: C8 68          EORB   #$40
D10D: 68 B7          ASL    -$1,Y
D10F: AE F0          LDX    Illegal Postbyte
D111: 75 BD A4       LSR    $3F26
D114: F0 6A C7       SUBB   $4845
D117: CB 6F          ADDB   #$47
D119: 60 DC          NEG    -$C,U
D11B: B7 0E BA       STA    $2692
D11E: C8 C8          EORB   #$40
D120: 62 62          XNC    $0,U
D122: C2 C2          SBCB   #$40
D124: 62 1D          XNC    -$1,Y
...
D128: 6E 69          JMP    $1,U
D12A: DD C4          STD    $4C
D12C: 7C 68 B7       INC    $403F
D12F: AA 28          ORA    $A,X
D131: 76 CA C7       ROR    $4845
D134: 62 75          XNC    -$9,U
D136: CB CC          ADDB   #$4E
D138: 66 6D          ROR    $5,U
D13A: DA C8          ORB    $40
D13C: 61 7B          NEG    -$D,U
D13E: B7 A9 A8       STA    $218A
D141: 67 CC          ASR    $E,U
D143: D6 67          LDB    $45
D145: 70 C2 DB       NEG    $4059
D148: 67 7D          ASR    -$B,U
D14A: DA C8          ORB    $40
D14C: 66 69          ROR    $1,U
D14E: C5 CD          BITB   #$45
...
D151: 04 09          LSR    $8B
D153: C0 77          SUBB   #$55
D155: 76 D6 CD       ROR    $544F
D158: 66 17          ROR    -$1,Y
D15A: AD 00 67       JSR    $4F,X
D15D: 66 CD          ROR    $5,U
D15F: C8 72          EORB   #$50
D161: 6E C3          JMP    $1,U
D163: DB 67          ADDB   $45
D165: 70 C2 CD       NEG    $404F
D168: 66 64          ROR    $C,U
D16A: D1 B7          CMPB   $3F
D16C: 0D AF          TST    $87
D16E: C7 C6          XSTB   #$4E
...
D172: CD             XHCF
D173: D0 62          SUBB   $40
D175: 76 D5 CD       ROR    $574F
D178: 68 78          ASL    -$10,U
D17A: C4 C9          ANDB   #$41
D17C: 71 6D DA       NEG    $4552
D17F: DB 1D          ADDB   $3F
D181: 07 04          ASR    $86
D183: CD             XHCF
D184: 6C 67          INC    $5,U
...
D188: 67 68          ASR    $0,U
D18A: DC C0          LDD    $48
D18C: 7A 6D CD       DEC    $4545
D18F: C8 72          EORB   #$50
D191: 6E C3          JMP    $1,U
D193: DB 67          ADDB   $45
D195: 70 D1 BD       NEG    $533F
D198: 0D AE          TST    $86
D19A: C7 C6          XSTB   #$4E
D19C: 6D 68          TST    $0,U
D19E: DC C7          LDD    $4F
...
D1B4: 1D             SEX
D1B5: 07 C3          ASR    $41
D1B7: B0 7D 78       SUBA   $5550
D1BA: B7 AD E9       STA    $25C1
D1BD: 1B             NOP
D1BE: DD D8          STD    $50
D1C0: 1D             SEX
D1C1: 04 C3          LSR    $41
D1C3: B6 77 72       LDA    $5550
D1C6: BD A6 6B       JSR    $2443
D1C9: 6E C4          JMP    $C,U
D1CB: D1 61          CMPB   $49
D1CD: 66 CF          ROR    $7,U
D1CF: B7 06 20       STA    $2402
D1D2: C6 CB          LDB    #$49
D1D4: 71 73 D7       NEG    $5155
D1D7: BD 0C 6B       JSR    $2443
D1DA: C8 C8          EORB   #$40
D1DC: 69 64          ROL    $C,U
D1DE: C1 CE          CMPB   #$46
D1E0: 7B 1D A0       XDEC   $3F22
D1E3: 4E             XCLRA
D1E4: 65 70          LSR    -$E,U
D1E6: C7 C3          XSTB   #$41
D1E8: 7C 81 21       INC    $A9A9
D1EB: B7 0B 60       STA    $2348
D1EE: DC C0          LDD    $48
D1F0: 6B 71          XDEC   -$D,U
D1F2: C2 CB          SBCB   #$49
D1F4: 71 62 D6       NEG    $4054
D1F7: CA 6D          ORB    #$45
D1F9: 17 AB 42       LBSR   $F5C6
D1FC: 61 66          NEG    $E,U
D1FE: C8 DC          EORB   #$54
D200: 6A 67          DEC    $5,U
D202: C2 D5          SBCB   #$57
D204: 6D 70          TST    -$E,U
D206: CE C6 17       LDU    #$443F
D209: 0C 0C          INC    $84
D20B: D1 67          CMPB   $4F
D20D: 7D DA C8       TST    $5240
D210: 6C 63          INC    $1,U
D212: CF C7 62       XSTU   #$4540
D215: 6B D1          XDEC   -$D,U
D217: C2 68          SBCB   #$40
D219: 7A CD CF       DEC    $4547
D21C: 61 7B          NEG    -$D,U
D21E: DC CD          LDD    $45
D220: 70 67 C6       NEG    $4544
D223: BD 07 25       JSR    $2507
D226: CB CC          ADDB   #$4E
D228: 68 7C          ASL    -$C,U
D22A: C0 CD          SUBB   #$45
D22C: 68 7B          ASL    -$D,U
D22E: CB C7          ADDB   #$4F
D230: 70 67 C2       NEG    $4540
D233: C0 6D          SUBB   #$4F
D235: 63 D0          COM    -$E,U
D237: C6 17          LDB    #$3F
D239: 0B DC          XDEC   $54
D23B: B9 7B 7C       ADCA   $5354
D23E: B7 AB 76       STA    $2354
D241: 10 CC C6 1D    LDD    #$443F
D245: 01 D6          NEG    $54
D247: B1 7A 6C       CMPA   $5244
D24A: B7 AF 3D       STA    $2715
D24D: 6E DA          JMP    -$E,U
D24F: CD             XHCF
D250: 67 62          ASR    $0,U
D252: D2 CE          SBCB   $4C
D254: 63 7B          COM    -$7,U
D256: BD A1 6A       JSR    $2342
D259: 78 C4 C9       ASL    $4C41
D25C: 71 6D DA       NEG    $4552
D25F: C8 13          EORB   #$31
D261: 1D             SEX
D262: A1 C0          CMPA   $2,U
D264: 72 6E C3       XNC    $4C41
D267: DB 6D          ADDB   $45
D269: 7A C8 BA       DEC    $4032
D26C: 17 0B CA       LBSR   $F5B1
D26F: D8 6E          EORB   $4C
D271: 63 DB          COM    -$7,U
D273: C7 70          XSTB   #$52
D275: 62 B1          XNC    -$D,Y
D277: BD 0B 6A       JSR    $2342
D27A: D8 C4          EORB   $4C
D27C: 69 71          ROL    -$7,U
D27E: CD             XHCF
D27F: DA 62          ORB    $40
D281: 16 BD A6       LBRA   $11A8
D284: 61 70          NEG    -$E,U
D286: C7 C3          XSTB   #$41
D288: 6C 71          INC    -$7,U
D28A: B7 A9 20       STA    $2108
D28D: 82 22          SBCA   #$AA
D28F: C8 76          EORB   #$54
D291: 70 CB D2       NEG    $4950
D294: 6E 67          JMP    $5,U
D296: C2 C8          SBCB   #$4A
D298: 7D 65 D8       TST    $4D50
D29B: C8 82          EORB   #$AA
D29D: 82 B7          SBCA   #$3F
D29F: A9 24          ADCA   $6,X
D2A1: 88 28          EORA   #$AA
...
D2BF: C8 74          EORB   #$56
D2C1: 63 D7          COM    -$B,U
D2C3: CE 76 62       LDU    #$5440
D2C6: 28 28          BVC    $D272
D2C8: 17 09 8D       LBSR   $F3D0
D2CB: 22 82          BHI    $D277
D2CD: 68 B9          ASL    -$F,Y
D2CF: B8 12 62       EORA   $3040
D2D2: CF C2 64       XSTU   #$4046
D2D5: 70 C7 C7       NEG    $4545
D2D8: 68 7B          ASL    -$D,U
D2DA: DC D1          LDD    $59
D2DC: 64 6D          LSR    $5,U
D2DE: C8 22          EORB   #$AA
...
D2E6: C2 D5          SBCB   #$57
D2E8: 6D 61          TST    $9,U
D2EA: CF C0 7C       XSTU   #$4854
D2ED: 68 C4          ASL    $C,U
D2EF: C1 64          CMPB   #$46
D2F1: 76 CB CC       ROR    $494E
D2F4: 65 62          LSR    $0,U
D2F6: 28 28          BVC    $D2A2
D2F8: 17 09 81       LBSR   $F404
D2FB: 22 82          BHI    $D2A7
D2FD: 68 C9          ASL    $1,U
D2FF: DA 61          ORB    $43
D301: 6A C7          DEC    $5,U
...
D311: 65 C2          LSR    $0,U
D313: CA 6D          ORB    #$4F
D315: 70 D1 C7       NEG    $5345
D318: 68 82          ASL    F,Y
D31A: 22 B7          BHI    $D35B
D31C: 0C 2F          INC    $07
D31E: BA C6 66       ORA    $4E44
D321: 1D             SEX
D322: A6 05          LDA    E,X
D324: 11 70 C6 BD    NEG    $443F
D328: 0D 2F          TST    $07
D32A: BC DC 60       CMPX   $5448
D32D: 17 AF DD       LBSR   $FA85
D330: 64 70          LSR    -$E,U
D332: C7 C7          XSTB   #$45
D334: 62 72          XNC    -$10,U
D336: CE C3 71       LDU    #$4159
D339: 17 CD 7F       LBSR   $1933
D33C: 6E 2A          JMP    $2,X
D33E: CE 41 B0       LDU    #$C992
D341: 54             LSRB
D342: 4E             XCLRA
D343: 60 B0          NEG    Illegal Postbyte
D345: 54             LSRB
D346: F9 14 88       ADCB   $96A0
D349: B9 F3 1E       ADCA   $7B96
D34C: 6E 22          JMP    $A,X
D34E: CE FB B4       LDU    #$7396
D351: D3 C4          ADDD   $46
D353: A1 64          CMPA   $6,U
D355: 6B C4          XDEC   $6,U
D357: D2 6E          SBCB   $46
D359: F9 CF 58       ADCB   $47D0
D35C: 61 DB          NEG    [,--S]
D35E: C2 8F          SBCB   #$07
D360: 6E 92 CF 8A    JMP    [$4D08,W]
D364: 6C 14          INC    -$A,Y
D366: C4 5B          ANDB   #$D9
D368: 6F 24          CLR    $C,X
D36A: CF FA 6E       XSTU   #$7246
D36D: C9 CE          ADCB   #$46
D36F: 76 21 23       ROR    $0301
D372: 84 87          ANDA   #$05
D374: 22 26          BHI    $D37A
D376: 80 C5          SUBA   #$47
D378: C9 60          ADCB   #$48
...
D38B: 95 64          BITA   $4C
D38D: 08 B5          ASL    $3D
D38F: B9 6D 03       ADCA   $4F21
D392: B1 91 1E       CMPA   $133C
D395: 27 9C          BEQ    $D3B5
D397: 91 16          CMPA   $3E
D399: 2C 92          BGE    $D3B5
D39B: C0 B5          SUBB   #$9D
...
D3B3: CA E3          ORB    #$C1
D3B5: 6A 43          DEC    ,U++
D3B7: E2 B4 A2       SBCB   [$D344,PCR]
D3BA: 27 2E          BEQ    $D362
D3BC: FC 4D 30       LDD    $65B8
D3BF: 3B             RTI
D3C0: FE B8 90       LDU    $9A12
D3C3: E9 EE 68       ADCB   $D410,PCR
D3C6: 9A 41          ORA    $C3
D3C8: 3D             MUL
D3C9: 62 97          XNC    -$1,X
D3CB: C4 29          ANDB   #$01
...
D3DF: C5 32          BITB   #$10
D3E1: 6F C1          CLR    $3,U
D3E3: CF 86 6F       XSTU   #$A44D
D3E6: 53             COMB
D3E7: CF CE 65       XSTU   #$E64D
D3EA: CB C6          ADDB   #$4E
D3EC: 21 65          BRN    $D43B
D3EE: C3 C5 BA       ADDD   #$4D98
D3F1: E3 CF          ADDD   $D,U
D3F3: 46             RORA
D3F4: F1 6C BC       CMPB   $4E3E
D3F7: CC 7B 29       LDD    #$5301
D3FA: 95 8B          BITA   $03
D3FC: 36 60          PSHU   S,DP
D3FE: 08 E0          ASL    $68
D400: A2 AA 02       SBCA   -$80,X
D403: 2A A2          BPL    $D385
D405: 77 3D 13       ASR    $BF91
D408: 16 9B 23       LBRA   $87B6
D40B: DD EA          STD    $C2
D40D: 97 11          STA    $99
D40F: 15             XHCF
D410: C3 77 57       ADDD   #$55D5
D413: 93 30          SUBD   $12
D415: 8A 2B          ORA    #$A9
D417: 28 3B          BVC    $D42C
D419: 3C 20          CWAI   #$A8
...
D42A: 88 89          EORA   #$01
D42C: 2A 29          BPL    $D42F
D42E: 8C 8D 24       CMPX   #$0506
D431: 3B             RTI
D432: 9F 9C          STX    $1E
D434: DD 37          STD    $15
D436: 94 95          ANDA   $17
D438: D7 FC          STB    $D4
D43A: CF 77 D7       XSTU   #$FFFF
D43D: FC CF 77       LDD    $47FF
D440: DD DD          STD    $FF
D442: 7D 7D DD       TST    $FFFF
D445: F6 D0 7D       LDB    $52FF
D448: 2B 2B          BMI    $D44D
D44A: 8B 8B          ADDA   #$03
D44C: 29 28          BVS    $D44E
D44E: 88 88          EORA   #$00
D450: 22 22          BHI    $D452
D452: 83 83 23       SUBD   #$0101
D455: 22 82          BHI    $D457
D457: 82 28          SBCA   #$00
D459: 28 88          BVC    $D45B
D45B: 88 28          EORA   #$00
...
D47A: 88 88          EORA   #$00
D47C: 20 28          BRA    $D47E
D47E: 8F 88 24       XSTX   #$0006
D481: 22 87          BHI    $D488
D483: 82 26          SBCA   #$04
D485: FA 5F 82       ORB    $DD00
D488: 28 F0          BVC    $D462
D48A: 55             LSRB
D48B: 50             NEGB
D48C: CB 28          ADDB   #$00
...
D490: 22 FA          BHI    $D46A
D492: 5F             CLRB
D493: CE 6E 6E       LDU    #$4C4C
D496: CE CE 64       LDU    #$4C4C
D499: F7 92 6E       STB    $1AE6
D49C: FC F7 77       LDD    $DFFF
D49F: 88 22          EORA   #$00
D4A1: C7 80          XSTB   #$02
D4A3: 61 EB CA F6    NEG    -$178C,U
D4A7: 60 59          NEG    -$F,S
D4A9: CF 2F 6A       XSTU   #$A7E2
D4AC: 59             ROLB
D4AD: 28 88          BVC    $D4AF
D4AF: 6E 06          JMP    $4,Y
D4B1: C6 E3          LDB    #$61
...
D4B9: CB 9F          ADDB   #$17
D4BB: 88 28          EORA   #$00
D4BD: CE 4D 6B       LDU    #$C5E3
D4C0: 8C C1 95       CMPX   #$E317
D4C3: 82 22          SBCA   #$00
D4C5: C5 FF          BITB   #$7D
D4C7: 82 28          SBCA   #$00
D4C9: 28 88          BVC    $D4CB
D4CB: 6D E8          TST    ,U+
D4CD: CC B2 61       LDD    #$3AE9
D4D0: BC 22 82       CMPX   >$0000
D4D3: 65 A6          LSR    ,X
D4D5: 22 82          BHI    $D4D7
D4D7: 82 28          SBCA   #$00
D4D9: 28 88          BVC    $D4DB
...
D4EA: 23 EB          BLS    $D54F
D4EC: 33 4B          LEAU   $3,S
D4EE: FE EC 77       LDU    $6455
D4F1: 47             ASRA
D4F2: B4 E2 8E       ANDA   $60AC
D4F5: 42             XNCA
D4F6: 53             COMB
D4F7: F3 EE 4A       ADDD   $C662
D4FA: C0 88          SUBB   #$00
D4FC: 2D 28          BLT    $D4FE
D4FE: 8A 88          ORA    #$00
D500: 22 22          BHI    $D502
...
D51A: 4C             INCA
D51B: ED 25          STD    $D,X
D51D: 38 9E          XANDCC #$16
D51F: 97 07          STA    $25
D521: 3E             XRES
D522: 82 E7          SBCA   #$65
D524: 63 47          COM    $5,S
D526: D7 E7          STB    $65
D528: BA 4D 85       ORA    $650D
D52B: ED E8          STD    ,U+
D52D: 4E             XCLRA
D52E: A8 E0          EORA   $8,S
D530: 76 48 62       ROR    $6AE0
D533: E9 20          ADCB   $2,X
D535: 47             ASRA
D536: 4A             DECA
D537: E4 3F          ANDB   -$9,X
...
D551: 4B             XDECA
D552: 9C EB          CMPX   $69
D554: 71 4B 47       NEG    $69C5
D557: EB C5 42 9B    ADDB   $13F6E,PCR
D55B: E2 F4 51       SBCB   [$D5D7,PCR]
D55E: 63 F2          COM    -$6,S
D560: 32 58          LEAS   -$6,S
D562: C6 F8          LDB    #$7A
D564: 5A             DECB
...
D575: 4E             XCLRA
D576: 21 EE          BRN    $D5E4
D578: F5 45 B0       BITB   $6D38
D57B: E6 10          LDB    -$8,Y
D57D: 47             ASRA
D57E: 90 F8          SUBA   $70
D580: 24 52          BCC    $D5F2
D582: F6 F2 98       LDB    $70BA
D585: 53             COMB
D586: 89 F3          ADCA   #$71
D588: 40             NEGA
D589: 59             ROLB
D58A: 09 F9          ROL    $71
D58C: B1 43 57       CMPA   $6BDF
D58F: E3 DD 4E 97    ADDD   [$6C15]
D593: EE 54          LDU    -$A,S
D595: 96 37          LDA    $B5
D597: 46             RORA
D598: ED 45          STD    $D,S
...
D59C: 4D             TSTA
D59D: 45             LSRA
D59E: 16 E9 43       LBRA   $3702
D5A1: 42             XNCA
D5A2: DD DC          STD    $5E
D5A4: 7F 7E 82       CLR    $5C00
D5A7: 6E C5 C6 67    JMP    $C49A,PCR
D5AB: 5D             TSTB
D5AC: D4 D5          ANDB   $FD
D5AE: 76 77 C7       ROR    $FFE5
D5B1: 82 3A          SBCA   #$B8
D5B3: 3B             RTI
D5B4: 98 99          EORA   $BB
D5B6: 16 4A E1       LBRA   $9E82
D5B9: E2 43          SBCB   D,U
D5BB: 2C 6E          BGE    $D603
D5BD: 69 B4          ROL    -$4,Y
D5BF: BF 10 0F       STX    $322D
D5C2: 83 83 22       SUBD   #$0100
D5C5: 23 83          BLS    $D5C8
D5C7: 87 29          XSTA   #$01
D5C9: 2A 88          BPL    $D5CB
D5CB: 89 2A          ADCA   #$02
...
D5D3: 87 23          XSTA   #$01
D5D5: 26 82          BNE    $D5D7
D5D7: 83 2C 2D       SUBD   #$0405
D5DA: 89 8D          ADCA   #$05
D5DC: 28 29          BVC    $D5DF
D5DE: 8D 8D          BSR    $D5E5
D5E0: 21 21          BRN    $D5E5
D5E2: 83 82 20       SUBD   #$0002
D5E5: 21 81          BRN    $D5EA
D5E7: 81 58          CMPA   #$70
D5E9: 26 F8          BNE    $D65B
D5EB: C9 58          ADCB   #$70
...
D5EF: 14             XHCF
D5F0: 52             XNCB
D5F1: 93 82          SUBD   game_playing_00
D5F3: 80 26          SUBA   #$04
D5F5: 27 84          BEQ    $D5FD
D5F7: 85 2F          BITA   #$07
D5F9: 20 80          BRA    $D603
D5FB: 80 20          SUBA   #$08
D5FD: 20 8F          BRA    $D606
D5FF: 8F 24 27       XSTX   #$0605
D602: 86 80          LDA    #$02
D604: 22 53          BHI    $D677
D606: 91 F3          CMPA   $71
D608: 37 59          PULU   CC,X,Y,S
D60A: 01 ED          NEG    $65
D60C: 69 4D          ROL    $5,S
D60E: DD ED          STD    $65
D610: B0 53 12       SUBA   $7190
D613: F3 83 53       ADDD   $A171
D616: 2A 82          BPL    $D618
D618: 28 48          BVC    $D67A
D61A: F8 50 38       EORB   $D810
D61D: 3A             ABX
D61E: 88 8E          EORA   #$06
D620: 24 27          BCC    $D627
D622: 8A 84          ORA    #$06
...
D626: 82 A1          SBCA   #$23
D628: 01 05          NEG    $2D
D62A: FC CB 5C       LDD    $4374
D62D: 6B FC          XDEC   -$C,S
D62F: B9 A6 F9       ADCA   $84DB
D632: 06 62          ROR    $E0
D634: A6 C7          LDA    B,S
D636: B4 6A 1E       ANDA   $E836
D639: D8 BE          EORB   $36
D63B: 68 1E          ASL    -$A,Y
D63D: C0 BE          SUBB   #$36
D63F: 50             NEGB
...
D658: 08 38          ASL    $10
D65A: 98 98          EORA   $10
D65C: 83 CD 77       SUBD   #$E5FF
D65F: 76 DF DE       ROR    $FDFC
D662: 5D             TSTB
D663: D2 62          SBCB   $40
D665: 12             NOP
D666: A2 92          SBCA   -$10,X
D668: 2D 28          BLT    $D66A
D66A: 89 88          ADCA   #$00
D66C: 29 5D          BVS    $D6E3
D66E: 89 18          ADCA   #$90
D670: 20 22          BRA    $D672
D672: 83 02 22       SUBD   #$8000
D675: 72 82 82       XNC    >$0000
D678: 28 78          BVC    $D6CA
D67A: 8C 88 2D       CMPX   #$0005
D67D: 28 8E          BVC    $D685
D67F: 88 24          EORA   #$06
D681: 72 84 E2       XNC    $0660
D684: 24 52          BCC    $D6F6
D686: 84 02          ANDA   #$80
D688: 2E B8          BGT    $D61A
D68A: 8F 88 2F       XSTX   #$0007
D68D: 2D 8F          BLT    $D696
D68F: 98 25          EORA   $07
D691: 37 85          PULU   CC,D
D693: A2 25          SBCA   $7,X
D695: 07 85          ASR    $07
D697: B2 2F 1D       SBCA   $0735
D69A: 8F C8 2F       XSTX   #$4007
D69D: 6D 8F          TST    $7,X
D69F: D8 25          EORB   $07
D6A1: 77 85 E2       ASR    $0760
D6A4: 25 47          BCS    $D70B
D6A6: 85 F2          BITA   #$70
D6A8: 53             COMB
D6A9: B6 F3 57       LDA    $7BDF
D6AC: 53             COMB
D6AD: D5 89          BITB   $01
D6AF: 8C 24 64       CMPX   #$0646
D6B2: 53             COMB
D6B3: C5 F2          BITB   #$D0
D6B5: 6B 71          XDEC   [,--S]
D6B7: C8 2F          EORB   #$07
D6B9: 64 38 88 22    LSR    [$000A,W]
D6BD: 29 8B          BVS    $D6C2
D6BF: 88 28          EORA   #$0A
D6C1: 23 81          BLS    $D6C6
D6C3: 82 20          SBCA   #$02
...
D6CF: CA 22          ORB    #$00
D6D1: 22 E2          BHI    $D733
D6D3: D2 22          SBCB   game_playing_00
D6D5: 42             XNCA
D6D6: 82 82          SBCA   #$00
D6D8: 2C 20          BGE    $D6E2
D6DA: 84 99          ANDA   #$11
D6DC: 3D             MUL
D6DD: 31 5E          LEAY   [A,U]
D6DF: 72 F5 48       XNC    $D76A
D6E2: 55             LSRB
D6E3: FD F5 A4       STD    $D786
D6E6: 55             LSRB
D6E7: 0F FF          CLR    $D7
D6E9: BC 88 88       CMPX   >$0000
D6EC: 28 28          BVC    $D6EE
D6EE: 88 88          EORA   #$00
D6F0: 23 23          BLS    $D6F3
D6F2: 80 80          SUBA   #$02
...
D712: 82 82          SBCA   #$00
D714: 23 22          BLS    $D716
D716: 83 83 28       SUBD   #$0100
D719: 28 88          BVC    $D71B
D71B: 89 29          ADCA   #$01
D71D: 29 89          BVS    $D720
D71F: 89 22          ADCA   #$00
D721: 22 80          BHI    $D725
D723: 83 21 23       SUBD   #$0301
D726: 83 82 28       SUBD   #$0000
D729: 2A 8A          BPL    $D72D
D72B: 8B 2A          ADDA   #$02
D72D: 29 88          BVS    $D72F
D72F: 88 21          EORA   #$03
...
D79A: 81 5F          CMPA   #$D7
D79C: 81 FF          CMPA   #$D7
D79E: 35 5F          PULS   CC,D,X,U,PC
D7A0: F3 F5 61       ADDD   $D7E3
D7A3: 55             LSRB
D7A4: DA FA          ORB    $D8
D7A6: 86 5A          LDA    #$D8
D7A8: 30 3A          LEAX   -$E,X
...
D7E9: 29 88          BVS    $D7EB
D7EB: 88 28          EORA   #$00
D7ED: 70 88 88       NEG    >$0000
D7F0: 77 22 82       ASR    >$0000
D7F3: D2 22          SBCB   game_playing_00
D7F5: 22 C7          BHI    $D83C
D7F7: 82 3D          SBCA   #$15
D7F9: 28 9E          BVC    $D811
D7FB: D8 30          EORB   $18
...
D832: 02 1C          XNC    $9E
D834: 42             XNCA
D835: FD 5C E2       STD    $DE60
D838: FF FE E8       STU    $D660
D83B: 7E 48 DF       JMP    $60F7
D83E: C8 61          EORB   #$E9
D840: 62 C8          XNC    F,S
D842: C2 69          SBCB   #$EB
D844: A2 CB 02 68    SBCA   -$7F16,S
D848: A8 C3          EORA   D,S
D84A: C8 64          EORB   #$EC
D84C: A8 C4 C8       EORA   $D88F,PCR
D84F: A0 22          SUBA   $0,X
D851: 0A C2          DEC    $40
D853: A7 22          STA    $0,X
D855: 07 C2          ASR    $40
...
D85D: 68 AC          ASL    $4,Y
D85F: A9 62          ADCA   $0,U
D861: FD 5C C2       STD    $DE40
D864: 06 00          ROR    $22
D866: C2 A6          SBCB   #$24
D868: 0B 28          XDEC   game_playing_00
D86A: 89 88          ADCA   #$00
D86C: 28 2A          BVC    $D870
D86E: 88 88          EORA   #$00
D870: 21 22          BRN    $D872
...
D8A9: 39             RTS
D8AA: AA 99          ORA    -$F,X
D8AC: 34 39          PSHS   X,CC
D8AE: 9A A3          ORA    $2B
D8B0: 0D 01          TST    $23
D8B2: A6 AC          LDA    $E,Y
D8B4: 39             RTS
D8B5: 00 9E          NEG    event_pointer_1c
D8B7: AA 08          ORA    $0,Y
D8B9: 33 AC          LEAU   $4,Y
D8BB: A6 33          LDA    -$5,X
D8BD: 37 A8          PULU   Y
D8BF: B9 02 05       ADCA   $2027
D8C2: A8 A9          EORA   $B,Y
D8C4: 02 3D          XNC    $1F
D8C6: AA BD          ORA    -$1,Y
D8C8: 0E 19          JMP    $31
D8CA: BD BC 0F       JSR    $3427
D8CD: 1B             NOP
D8CE: A7 89          STA    $1,X
D8D0: 20 21          BRA    $D8D5
D8D2: 87 84          XSTA   #$06
...
D906: E6 72          LDB    [,--W]
D908: 28 28          BVC    $D90A
D90A: CE E0 4E       LDU    #$6866
D90D: 40             NEGA
D90E: 0E E0          JMP    $68
D910: 84 4A          ANDA   #$68
D912: FA A6 22       ORB    $2400
D915: 22 DE          BHI    $D973
D917: A2 28          SBCA   $0,X
D919: 28 88          BVC    $D91B
D91B: 88 28          EORA   #$00
...
D923: 02 6D          XNC    $4F
D925: 5C             INCB
D926: 0A 82          DEC    game_playing_00
D928: 99 2B          ADCA   $03
D92A: 88 88          EORA   #$00
D92C: 28 28          BVC    $D92E
D92E: D4 A8          ANDB   $20
...
D953: 81 02          CMPA   #$20
D955: 23 5B          BLS    $D930
D957: EC F1 46 51    LDD    [$6ED9,U]
D95B: EC F1 BF 51    LDD    [-$6827,U]
D95F: 1F FB          TFR    inv,B
D961: B5 5B 06       BITA   $D984
D964: A1 A5          CMPA   E,X
D966: 82 33          SBCA   #$B1
D968: 88 28          EORA   #$00
D96A: 39             RTS
D96B: 28 28          BVC    $D96D
D96D: D7 0B          STB    $83
D96F: 0F 22          CLR    game_playing_00
D971: A1 1A 82       CMPA   [$00,X]
D974: A1 8B 82 01    CMPA   $0083,Y
D978: 81 28          CMPA   #$00
D97A: 0B 21          XDEC   $A9
D97C: 28 AB          BVC    $D901
D97E: B5 88 A0       BITA   >$0082
D981: 8D 82          BSR    $D983
D983: 7D A1 A5       TST    $8387
D986: 82 01          SBCA   #$83
D988: B0 28 0D       SUBA   >$0085
D98B: 28 28          BVC    $D98D
D98D: AD 28          JSR    ,Y+
D98F: 88 A7          EORA   #$85
D991: 82 82          SBCA   #$00
...
D9D3: 92 E2          SBCA   $C0
D9D5: 0D AC          TST    $2E
D9D7: 8F 24 2F       XSTX   #$0C07
D9DA: 8E 48 07       LDX    #$C02F
D9DD: 06 87          ROR    $0F
D9DF: 86 27          LDA    #$05
D9E1: 26 42          BNE    $D9A3
D9E3: AF 0E          STX    $C,Y
...
DA04: 5A             DECB
DA05: 4C             INCA
DA06: F2 EC 68       SBCB   $6E40
DA09: 10 E6 F1       LDB    -$7,S
DA0C: 46             RORA
DA0D: 59             ROLB
DA0E: E6 C8          LDB    $0,U
DA10: 1B             NOP
DA11: 4C             INCA
DA12: F8 EC 50       EORB   $6E72
DA15: 4C             INCA
DA16: C2 BA          SBCB   #$38
DA18: 46             RORA
DA19: 53             COMB
...
DA1F: E6 5E          LDB    -$4,S
DA21: 4C             INCA
DA22: F6 EC E2       LDB    $6EC0
DA25: 1A EC          ORCC   #$6E
DA27: FF 46 5D       STU    $6E75
DA2A: E6 48          LDB    ,U+
DA2C: 11 46          RORA
DA2E: F6 E6 54       LDB    $6E76
DA31: 4C             INCA
DA32: 42             XNCA
DA33: BA 4C 5D       ORA    $6E7F
DA36: EC F5          LDD    -$9,S
DA38: 46             RORA
DA39: E8 B8          EORB   -$10,Y
DA3B: E6 D7 F2 8C    LDB    [$DA04]
DA3F: 0A 4C          DEC    $6E
DA41: A1 EC          CMPA   $E,S
DA43: 0E 4C          JMP    $6E
DA45: A6 EC          LDA    $E,S
DA47: C2 11          SBCB   #$39
DA49: 46             RORA
DA4A: C3 C2 6B       ADDD   #$4A43
DA4D: 6A 88          DEC    $0,X
DA4F: 88 22          EORA   #$00
DA51: 7D DC D5       TST    $5E57
DA54: 74 22 82       LSR    >$0000
DA57: 82 D7          SBCA   #$FF
DA59: F2 C2 D5       SBCB   $4A5D
DA5C: 74 7D DC       LSR    $5554
DA5F: C8 0F          EORB   #$2D
DA61: 0E DB          JMP    $59
DA63: DA 73          ORB    $51
DA65: 72 C2 AF       XNC    $402D
DA68: 04 D7          LSR    $FF
DA6A: 52             XNCB
DA6B: D3 D7          ADDD   $FF
DA6D: D6 7F          LDB    $F7
DA6F: E6 62          LDB    $0,U
DA71: 0F AE          CLR    $2C
DA73: 74 DC 4C       LSR    $FE6E
DA76: EC C2          LDD    $0,U
DA78: 05 04          LSR    $2C
DA7A: 77 52 44       ASR    $DA6C
DA7D: 68 A5          ASL    $D,Y
DA7F: A4 62          ANDA   $0,U
DA81: 0D AC          TST    $2E
DA83: C2 08          SBCB   #$2A
...
DA8B: A6 E8          LDA    ,U+
DA8D: 05 A4          LSR    $2C
DA8F: 77 F8 5F       ASR    $DA7D
DA92: C2 AD          SBCB   #$2F
DA94: 0C 62          INC    $40
DA96: AF AE          STX    $C,Y
DA98: 68 07          ASL    $F,Y
DA9A: A6 77 F2 BA    LDA    [$DA92]
DA9E: 81 80          CMPA   #$08
DAA0: CF 88 C2       XSTU   #$AA40
DAA3: AF 0E          STX    $C,Y
DAA5: 29 88          BVS    $DAB1
DAA7: 23 82          BLS    $DA53
DAA9: 68 A7          ASL    $F,Y
...
DAFE: 2B 2A          BMI    $DAA2
DB00: 62 0F          XNC    $D,Y
DB02: AE 2F 8E 87    LDX    $87AB,PCR
DB06: 26 C2          BNE    $DB48
DB08: 05 04          LSR    $2C
DB0A: E6 26          LDB    W,Y
DB0C: 46             RORA
DB0D: 8E C8 A5       LDX    #$402D
DB10: 0E 4C          JMP    $6E
DB12: 3A             ABX
DB13: EC 92 62 AF    LDD    [$402D,W]
DB17: AE 46          LDX    $E,S
DB19: 91 3A          CMPA   $B2
DB1B: 39             RTS
DB1C: 68 05          ASL    $D,Y
DB1E: A4 35 4C 97    ANDA   [$149D7,PCR]
DB22: 36 C2          PSHU   S
DB24: 0F 0E          CLR    $2C
DB26: 39             RTS
DB27: EC 9B          LDD    [,--Y]
...
DB2F: E6 94          LDB    [A,Y]
DB31: 62 AD          XNC    $F,Y
DB33: AC EF EE 47    CMPX   $A7FC,PCR
DB37: 46             RORA
DB38: 68 07          ASL    $F,Y
DB3A: A6 91          LDA    -$7,X
DB3C: 30 E3          LEAX   D,U
...
DB8C: 68 07          ASL    $F,Y
DB8E: A6 53          LDA    [D,U]
DB90: F8 F1 50       EORB   $D3D2
DB93: C2 0D          SBCB   #$2F
DB95: 0C 59          INC    $DB
DB97: 58             ASLB
DB98: FB FA C8       ADDB   $D240
DB9B: A7 06          STA    $E,Y
DB9D: 65 C4          LSR    $C,U
DB9F: CD             XHCF
DBA0: 66 62          ROR    $0,U
DBA2: AD AC          JSR    $E,Y
DBA4: FF FE 57       STU    $DCD5
DBA7: 56             RORB
DBA8: 68 07          ASL    $F,Y
DBAA: A6 57 F6 FF    LDA    [$DED7]
DBAE: 5E             XCLRB
DBAF: C8 0D          EORB   #$2F
DBB1: 0C D9          INC    $5B
DBB3: D8 71          EORB   $53
...
DC67: EE 48          LDU    $0,S
DC69: 2B E7          BMI    $DCDA
DC6B: E6 D7 F4 EC    LDB    [$DC64]
DC6F: E8 21          EORB   $3,X
DC71: 44             LSRA
DC72: 9E E2          LDX    $60
DC74: 21 45          BRN    $DCDD
DC76: 9E 7D          LDX    $FF
DC78: F4 47 E8       ANDB   $6F60
DC7B: F3 52 88       ADDD   $7AA0
DC7E: F2 F3 C9       SBCB   $7BEB
DC81: C8 61          EORB   #$E3
DC83: 60 CF CE 67    NEG    $C96C,PCR
DC87: 66 C1 C0 69    ROR    -$171F,S
DC8B: 68 48          ASL    $0,S
DC8D: 64 E8          LSR    $0,S
DC8F: D7 4A          STB    $68
DC91: 6E E2          JMP    $0,S
...
DCAE: E2 E3          SBCB   $B,S
DCB0: 49             ROLA
DCB1: 75 EE E9       LSR    $6C6B
DCB4: 4E             XCLRA
DCB5: 75 E8 D5       LSR    $6A57
DCB8: 43             COMA
DCB9: 4B             XDECA
DCBA: C3 E7 68       ADDD   #$6F40
DCBD: A6 05 0E A7    LDA    $6346,PCR
DCC1: 62 0D          XNC    ,W
DCC3: 05 62          LSR    $40
DCC5: AC 14          CMPX   [A,X]
DCC7: 04 AD          LSR    $85
...
DCD8: 48             ASLA
DCD9: DA E8          ORB    $60
DCDB: 6F D7 F4 50    CLR    [$DCD8]
DCDF: E8 D6          EORB   [,S]
DCE1: 42             XNCA
DCE2: 6D 7D FE FD    TST    [$DCDF]
DCE6: E2 76          SBCB   [,S]
DCE8: 48             ASLA
DCE9: DD 77          STD    $FF
DCEB: 54             LSRB
DCEC: CE 88 B8       LDU    #$A030
DCEF: B9 1A 1B       ADCA   $3839
DCF2: C2 AF          SBCB   #$2D
DCF4: 0E 82          JMP    $A0
DCF6: B6 B7 14       LDA    $353C
DCF9: 15             XHCF
DCFA: C8 A5          EORB   #$2D
DCFC: 04 48          LSR    $60
DCFE: A1 A0          CMPA   $8,Y
...
DD0A: C8 A7          EORB   #$2F
DD0C: 06 48          ROR    $60
DD0E: B1 B0 13       CMPA   $3831
DD11: 12             NOP
DD12: C2 AF          SBCB   #$2D
DD14: 0E 42          JMP    $60
DD16: BF BE 1D       STX    $3C35
DD19: 1C C8          ANDCC  #$40
DD1B: A5 04          BITA   $C,Y
DD1D: 48             ASLA
DD1E: C1 C0          CMPB   #$48
...
DD48: 2B 68          BMI    $DD8A
DD4A: A3 A2          SUBD   $A,Y
DD4C: 73 2B DB       COM    $0353
DD4F: DA 62          ORB    $40
DD51: 09 A8          ROL    $2A
DD53: DE 21          LDU    $03
DD55: 76 81 C2       ROR    $0340
DD58: 03 02          COM    $2A
DD5A: 8B 8B          ADDA   #$03
DD5C: 75 57 F6       LSR    $7F7E
DD5F: FF 54 62       STU    $7640
DD62: A9 A8          ADCA   $A,Y
DD64: DB DA          ADDB   $F8
DD66: 73 72 68       COM    $F040
DD69: 05 A4          LSR    $2C
DD6B: 73 D2 DB       COM    $FAF3
DD6E: 8B C8          ADDA   #$40
DD70: 0F 0E          CLR    $2C
DD72: C2 1A          SBCB   #$98
DD74: B2 99 38       SBCA   $BBBA
DD77: 31 9A          LEAY   Illegal Postbyte
DD79: 68 A3          ASL    $B,Y
DD7B: A2 95 94 3D    SBCA   [$9A34,PCR]
DD7F: 3C 62          CWAI   #$40
DD81: 09 A8          ROL    $2A
DD83: 3D             MUL
DD84: 9C 95          CMPX   $B7
DD86: 34 C2          PSHS   U
DD88: 03 02          COM    $2A
DD8A: 31 30 99       LEAY   [-$4F,Y]
DD8D: 98 01          EORA   $89
DD8F: 00 A3          NEG    $81
DD91: A2 09          SBCA   D,X
DD93: 08 A1          ASL    $83
DD95: A0 0F 0E AD    SUBA   $6A1E,PCR
DD99: AC E8          CMPX   $0,S
DD9B: 1F 2B          TFR    D,U
DD9D: 48             ASLA
DD9E: 17 8B 42       LBSR   $E101
DDA1: A4 81          ANDA   $3,X
DDA3: E2 A5          SBCB   E,X
DDA5: 21 E2          BRN    $DE07
DDA7: 0C 2B          INC    $03
...
DDAA: 07 8B          ASR    $03
DDAC: 48             ASLA
DDAD: BA 8B E8       ORA    $0360
DDB0: B6 B1 E2       LDA    $9360
DDB3: 14             XHCF
DDB4: B7 21 1A       STA    $0398
DDB7: 81 B8          CMPA   #$90
DDB9: 2B 11          BMI    $DD54
DDBB: 8B B9          ADDA   #$91
DDBD: 2B 12          BMI    $DD59
...
DDC5: 21 1E          BRN    $DD63
DDC7: 81 2B          CMPA   #$03
DDC9: B6 15 8B       LDA    $9D03
DDCC: 2B 48          BMI    $DE2E
DDCE: 28 E8          BVC    $DE30
DDD0: 83 42 20       SUBD   #$60A2
DDD3: E2 81          SBCB   ,--Y
DDD5: 42             XNCA
DDD6: 26 E2          BNE    $DE38
DDD8: 8D 48          BSR    $DE3A
...
DE56: C4 12          ANDB   #$90
DE58: E0 C8          SUBB   ,S+
DE5A: CF 18 F0       XSTU   #$90D8
DE5D: 88 CE          EORA   #$46
DE5F: 28 9A          BVC    $DE19
DE61: 42             XNCA
DE62: CC 22 EA       LDD    #$A0C8
DE65: 42             XNCA
DE66: CD             XHCF
DE67: 22 F0          BHI    $DE41
DE69: 08 C6          ASL    $4E
DE6B: 38 90          XANDCC #$B8
DE6D: 48             ASLA
DE6E: CE 38 EA       LDU    #$B0C8
DE71: 42             XNCA
DE72: C5 32          BITB   #$B0
DE74: FA 02 C4       ORB    $2046
DE77: C2 19          SBCB   #$31
DE79: 48             ASLA
DE7A: F9 F8 48       ADCB   $7060
DE7D: 59             ROLB
DE7E: FA E8 53       ORB    $6071
DE81: 51             NEGB
DE82: E2 F3          SBCB   -$F,S
DE84: 56             RORB
DE85: 82 F1          SBCA   #$73
DE87: F3 88 5C       ADDD   $A074
DE8A: F9 E8 55       ADCB   $607D
DE8D: 54             LSRB
DE8E: E8 FD          EORB   -$B,S
DE90: 42             XNCA
DE91: 5B             XDECB
DE92: FA 82 27       ORB    >$0005
DE95: 27 82          BEQ    $DE97
DE97: 82 28          SBCA   #$00
DE99: 2D 8D          BLT    $DEA0
DE9B: 88 28          EORA   #$00
...
DEFD: 1E 89          EXG    D,X
DEFF: 9A 23          ORA    $01
DF01: 38 83          XANDCC #$01
DF03: 94 23          ANDA   $01
DF05: 18             X18
DF06: 83 A9 29       SUBD   #$2B01
DF09: 3E             XRES
DF0A: 8C AE 2C       CMPX   #$2604
DF0D: 3A             ABX
DF0E: 89 F8          ADCA   #$70
DF10: 23 04          BLS    $DF38
DF12: 83 AA 23       SUBD   #$2801
DF15: 10 83 98 2C    CMPD   #$1A04
DF19: D8 88          EORB   game_playing_00
DF1B: B5 78 68       BITA   $5040
DF1E: B8 B9 0E       EORA   $312C
DF21: 23 D2          BLS    $DF73
DF23: C2 69          SBCB   #$4B
DF25: 13             SYNC
DF26: AE 94          LDX    -$A,X
DF28: 78 68 B8       ASL    $4030
DF2B: B9 04 29       ADCA   $2C01
DF2E: D8 C8          EORB   $40
DF30: 12             NOP
DF31: 13             SYNC
DF32: AE 83          LDX    $1,X
DF34: 72 62 B2       XNC    $4030
DF37: B6 1D 29       LDA    $3501
DF3A: D8 C8          EORB   $40
DF3C: 1A 19          ORCC   #$31
DF3E: A4 89          ANDA   $1,X
DF40: 72 61 B1       XNC    $4333
DF43: CE 0E 2A       LDU    #$2C08
DF46: D2 C2          SBCB   $40
DF48: 18             X18
DF49: 19             DAA
DF4A: A4 89          ANDA   $1,X
DF4C: 78 68 CD       ASL    $4045
DF4F: B9 0E 30       ADCA   $2C12
DF52: D2 C2          SBCB   $40
DF54: 12             NOP
DF55: 13             SYNC
DF56: AE 83          LDX    $1,X
DF58: 78 68 D7       ASL    $405F
DF5B: E0 04          SUBB   $C,Y
DF5D: 29 D8          BVS    $DFAF
DF5F: C8 14          EORB   #$36
DF61: 4B             XDECA
DF62: BA 83 72       ORA    $0150
DF65: 65 B5          LSR    -$9,Y
DF67: E8 11          EORB   -$7,Y
DF69: 29 D8          BVS    $DFBB
DF6B: C0 76          SUBB   #$5E
DF6D: 43             COMA
DF6E: F6 89 72       LDB    $0150
DF71: 6B DC          XDEC   -$2,U
DF73: E8 4C          EORB   $E,S
DF75: 23 D2          BLS    $DFC7
DF77: CB 05          ADDB   #$2D
DF79: 42             XNCA
DF7A: B2 89 78       SBCA   $0150
DF7D: 61 D6          NEG    -$2,U
DF7F: E2 5C          SBCB   -$2,S
DF81: 23 D2          BLS    $DFD3
DF83: CB 7C          ADDB   #$5E
DF85: 48             ASLA
DF86: EC 83          LDD    $1,X
DF88: 78 61 D6       ASL    $495E
DF8B: E2 13          SBCB   -$5,Y
DF8D: 29 D8          BVS    $DFDF
DF8F: C1 7C          CMPB   #$5E
DF91: 48             ASLA
DF92: FC 83 72       LDD    $0150
DF95: 6B DC          XDEC   -$2,U
DF97: E8 46          EORB   $E,S
DF99: 29 D8          BVS    $DFEB
DF9B: C1 76          CMPB   #$5E
DF9D: 42             XNCA
DF9E: B4 89 72       ANDA   $0150
DFA1: 6B DC          XDEC   -$2,U
DFA3: E9 5C          ADCB   -$2,S
DFA5: 23 D2          BLS    $DFF7
DFA7: CB 76          ADDB   #$5E
DFA9: 42             XNCA
DFAA: E6 89          LDB    $1,X
DFAC: 78 61 D6       ASL    $495E
DFAF: E2 1F          SBCB   -$3,Y
DFB1: 23 D2          BLS    $E003
DFB3: CB 7C          ADDB   #$5E
DFB5: 48             ASLA
DFB6: FC 83 78       LDD    $0150
DFB9: 61 D6          NEG    -$2,U
DFBB: E2 46          SBCB   $E,S
DFBD: 29 D8          BVS    $E00F
DFBF: C1 7C          CMPB   #$5E
DFC1: 48             ASLA
DFC2: BC 83 72       CMPX   $0150
DFC5: 6B DC          XDEC   -$2,U
DFC7: E8 56          EORB   -$2,S
DFC9: 29 D8          BVS    $E01B
DFCB: C1 76          CMPB   #$5E
DFCD: 42             XNCA
DFCE: E6 89          LDB    $1,X
DFD0: 72 6B DC       XNC    $495E
DFD3: E8 1D          EORB   -$1,Y
DFD5: 23 D2          BLS    $E027
DFD7: CB 76          ADDB   #$5E
DFD9: 43             COMA
DFDA: F6 89 78       LDB    $0150
DFDD: 61 D6          NEG    -$2,U
DFDF: E2 4C          SBCB   $E,S
DFE1: 23 D2          BLS    $E033
DFE3: CB 7C          ADDB   #$5E
DFE5: 48             ASLA
DFE6: CF 83 78       XSTU   #$0150
DFE9: 61 D6          NEG    -$2,U
DFEB: E2 56          SBCB   -$2,S
DFED: 29 D8          BVS    $E03F
DFEF: C1 7C          CMPB   #$5E
DFF1: 48             ASLA
DFF2: EC 83          LDD    $1,X
DFF4: 72 6B DC       XNC    $495E
DFF7: E8 66          EORB   $E,U
DFF9: D7 D8          STB    $50
DFFB: C1 76          CMPB   #$5E
DFFD: 42             XNCA
DFFE: A4 88          ANDA   $0,X
E000: 78 72 C2       ASL    $5040
E003: B2 13 0E       SBCA   $312C
E006: 83 D2 68       SUBD   #$5040
E009: 18             X18
E00A: C4 A4          ANDB   #$2C
E00C: 29 78          BVS    $E05E
E00E: C8 B8          EORB   #$30
...
E013: D2 62          SBCB   $40
E015: 4D             TSTA
E016: B3 AE 29       SUBD   $2C01
E019: 78 C8 E8       ASL    $4060
E01C: 19             DAA
E01D: 04 89          LSR    $01
E01F: D8 62          EORB   $40
E021: 43             COMA
...
E024: 23 72          BLS    $E076
E026: C2 E0          SBCB   #$62
E028: 7A 6A 89       DEC    $4201
E02B: D8 68          EORB   $40
E02D: 4B             XDECA
E02E: DB F9          ADDB   $71
E030: 23 72          BLS    $E082
E032: C2 E6          SBCB   #$64
E034: 71 50 83       NEG    $7201
E037: D2 5D          SBCB   $75
E039: 4D             TSTA
E03A: DD FB          STD    $73
E03C: 29 78          BVS    $E08E
E03E: FE EE 74       LDU    $6656
E041: 56             RORB
E042: 8B D2          ADDA   #$50
E044: 55             LSRB
E045: 45             LSRA
E046: D5 F6          BITB   $74
E048: 29 78          BVS    $E09A
E04A: FF EF 7F       STU    $6757
E04D: 72 89 D8       XNC    $0150
E050: 55             LSRB
E051: 45             LSRA
E052: D5 D9          BITB   $5B
E054: 23 72          BLS    $E0A6
E056: F5 E5 7F       BITB   $6757
E059: 74 89 D8       LSR    $0150
E05C: 5F             CLRB
E05D: 4F             CLRA
E05E: D0 D5          SUBB   $5D
E060: 23 72          BLS    $E0B2
E062: FE EE 7B       LDU    $6C59
E065: 0E 7D          JMP    $FF
E067: D2 6E          SBCB   $46
E069: 62 DC          XNC    -$C,U
E06B: A4 28          ANDA   $0,X
...
E074: A2 23          SBCA   $1,X
E076: 33 23          LEAU   ,Y++
E078: B9 A9 89       ADCA   $8101
E07B: 3A             ABX
E07C: 8A BA          ORA    #$92
E07E: 0A 89          DEC    $01
E080: 91 81          CMPA   $A3
E082: 11 01 23       NEG    $01
E085: 92 22          SBCA   $A0
E087: 12             NOP
E088: A8 29          EORA   $1,X
E08A: 39             RTS
...
E0B0: A2 23          SBCA   $1,X
E0B2: 33 23          LEAU   ,Y++
E0B4: B3 A3 83       SUBD   $8101
E0B7: 30 8A          LEAX   ,-Y
E0B9: BA 0A 89       ORA    $8201
E0BC: 9B 8B          ADDA   $A3
E0BE: 1B             NOP
E0BF: 0B 23          XDEC   $01
E0C1: 92 22          SBCA   $A0
...
E0C4: A2 23          SBCA   $1,X
E0C6: 33 23          LEAU   ,Y++
E0C8: B9 A9 89       ADCA   $8101
E0CB: 3A             ABX
E0CC: 8A BA          ORA    #$92
E0CE: 0A 89          DEC    $01
E0D0: 91 81          CMPA   $A3
E0D2: 11 01 23       NEG    $01
E0D5: 92 22          SBCA   $A0
E0D7: 12             NOP
E0D8: A8 29          EORA   $1,X
E0DA: 39             RTS
...
E100: A2 23          SBCA   $1,X
E102: 33 23          LEAU   ,Y++
E104: B3 A3 83       SUBD   $8101
E107: 30 8A          LEAX   ,-Y
E109: BA 0A 89       ORA    $8201
E10C: 9B 8B          ADDA   $A3
E10E: 1B             NOP
E10F: 0B 23          XDEC   $01
E111: 92 22          SBCA   $A0
...
E114: A2 23          SBCA   $1,X
E116: 33 23          LEAU   ,Y++
E118: B9 A9 89       ADCA   $8101
E11B: 3A             ABX
E11C: 8A BA          ORA    #$92
E11E: 0A 89          DEC    $01
E120: 91 81          CMPA   $A3
E122: 11 01 23       NEG    $01
E125: 92 22          SBCA   $A0
E127: 12             NOP
E128: A8 29          EORA   $1,X
E12A: 39             RTS
...
E132: 00 83          NEG    $01
E134: 91 81          CMPA   $A3
E136: 11 01 29       NEG    $01
E139: 8F 1F 0F       XSTX   #$9787
E13C: A8 29          EORA   $1,X
E13E: 10 98 AA       EORA   $88
E141: A3 83          SUBD   $1,X
E143: 2A 32          BPL    $E155
E145: AA 00          ORA    ,-X
E147: 83 80 A2       SUBD   #$A88A
E14A: 00 0B          NEG    $83
E14C: 29 80          BVS    $E0F6
E14E: 98 00          EORA   $88
E150: A2 23          SBCA   $1,X
...
E164: A2 23          SBCA   $1,X
E166: 33 23          LEAU   ,Y++
E168: B9 A9 89       ADCA   $8101
E16B: 3A             ABX
E16C: 8A BA          ORA    #$92
E16E: 0A 89          DEC    $01
E170: 91 81          CMPA   $A3
E172: 11 01 23       NEG    $01
E175: 92 22          SBCA   $A0
E177: 12             NOP
E178: A8 29          EORA   $1,X
E17A: 39             RTS
...
E1A0: A2 23          SBCA   $1,X
E1A2: 33 23          LEAU   ,Y++
E1A4: B3 A3 83       SUBD   $8101
E1A7: 30 8A          LEAX   ,-Y
E1A9: BA 0A 89       ORA    $8201
E1AC: 9B 8B          ADDA   $A3
E1AE: 1B             NOP
E1AF: 0B A2          XDEC   $80
E1B1: 23 A2          BLS    $E1D3
...
E1B9: 09 98          ROL    $10
E1BB: 98 38          EORA   $10
E1BD: 38 89          XANDCC #$01
E1BF: 89 03          ADCA   #$21
E1C1: 32 92          LEAS   -$10,X
E1C3: 92 32          SBCA   $10
E1C5: 20 83          BRA    $E1C8
E1C7: A3 38          SUBD   -$10,X
E1C9: 38 98          XANDCC #$10
E1CB: 98 2B          EORA   $03
E1CD: 29 A9          BVS    $E1F0
E1CF: 98 32          EORA   $10
E1D1: 32 92          LEAS   -$10,X
E1D3: 86 23          LDA    #$01
E1D5: 03 92          COM    $10
E1D7: 92 38          SBCA   $10
E1D9: 38 8D          XANDCC #$05
E1DB: 8C 09 38       CMPX   #$2110
E1DE: 98 98          EORA   $10
E1E0: 32 23          LEAS   $1,X
E1E2: 83 A4 34       SUBD   #$2616
E1E5: 34 94          PSHS   X,D
E1E7: 94 2E          ANDA   $06
E1E9: 29 AF          BVS    $E212
E1EB: 9D 3B          JSR    $13
...
E1FC: 21 2F          BRN    $E205
E1FE: 89 AF          ADCA   #$27
E200: 32 32          LEAS   -$10,X
E202: 92 88          SBCA   $0A
E204: 25 23          BCS    $E207
E206: A5 92          BITA   -$10,X
E208: 38 38          XANDCC #$10
E20A: 83 8F 29       SUBD   #$0701
E20D: 0F 98          CLR    $10
E20F: 98 32          EORA   $10
E211: 2E 85          BGT    $E21A
E213: 83 05 32       SUBD   #$2710
E216: 92 92          SBCA   $10
E218: 25 2F          BCS    $E221
E21A: 89 AF          ADCA   #$27
E21C: 38 38          XANDCC #$10
E21E: 98 86          EORA   $0E
E220: 25 23          BCS    $E223
E222: A5 92          BITA   -$10,X
E224: 32 32          LEAS   -$10,X
E226: 8D 85          BSR    $E22F
E228: 29 0F          BVS    $E251
E22A: 98 98          EORA   $10
E22C: 38 33          XANDCC #$1B
E22E: 8F 8A 05       XSTX   #$0227
E231: 32 92          LEAS   -$10,X
E233: 92 32          SBCA   $10
E235: 25 83          BCS    $E238
E237: AA 04          ORA    $C,Y
E239: 04 A4          LSR    $2C
...
E251: 30 B3          LEAX   -$F,Y
E253: 9E 73          LDX    $51
E255: 32 92          LEAS   -$10,X
E257: 92 38          SBCA   $10
E259: 19             DAA
E25A: 89 DA          ADCA   #$52
E25C: 6A 6A          DEC    $2,U
E25E: CA CA          ORB    #$42
E260: 10 A2 7D 04 A4 SBCA   [$8686]
E265: DC 04          LDD    $86
E267: 7C D6 A8       INC    $FE80
E26A: 77 F3 72       ASR    $7B5A
E26D: 6F CF          CLR    $7,U
E26F: CF 65 A2       XSTU   #$4780
E272: 0B 0B          XDEC   $89
E274: AD AD          JSR    ,W
E276: 04 40          LSR    $C2
E278: 9A A7          ORA    $8F
...
E27C: EB 9B          ADDB   [,--Y]
E27E: 07 53          ASR    $DB
E280: FA 82 12       ORB    $A090
E283: 02 FE          XNC    $DC
E285: FB 2F 13       ADDB   $AD91
E288: A9 F5 52 2A    ADCA   [$BD2E,PCR]
E28C: BA AA 07       ORA    $828F
E28F: 0E 81          JMP    $A3
E291: B1 01 0D       CMPA   $838F
E294: A4 83          ANDA   ,Y++
E296: 16 01 A7       LBRA   $6628
E299: AE 25 1D AB    LDX    $7820,PCR
E29D: A7 0E          STA    A,X
E29F: 2A B4          BPL    $E237
E2A1: A1 0D          CMPA   ,W
E2A3: 04 81          LSR    $A3
E2A5: B5 05 0D       BITA   $878F
E2A8: AE 86          LDX    W,Y
E2AA: 16 06 A7       LBRA   $713C
E2AD: AE 27 17 AD    LDX    -$6071,W
E2B1: E9 39          ADCB   [D,Y]
E2B3: 0B AB          XDEC   $89
E2B5: AD 4E 3E       JSR    $E274,PCR
E2B8: D2 C2          SBCB   $EA
E2BA: 07 45          ASR    $CD
E2BC: 95 D3          BITA   $FB
E2BE: 63 07          COM    ,W
...
E2CC: E9 99          ADCB   [,Y++]
E2CE: 07 07          ASR    $8F
E2D0: A4 AB 0B 0D    ANDA   -$7671,X
E2D4: AD A4          JSR    A,X
E2D6: 64 54          LSR    [A,U]
E2D8: A7 A7          STA    ,W
E2DA: 0E 6F          JMP    $E7
E2DC: FF E0 30       STU    $C8B8
E2DF: 0E AB          JMP    $89
E2E1: AB 4B 3B A4    ADDA   -$467A,U
E2E5: E6 36          LDB    [,Y]
E2E7: 48             ASLA
E2E8: 92 AE          SBCA   $86
E2EA: 4D             TSTA
...
E34E: 48             ASLA
E34F: 89 E3          ADCA   #$C1
E351: C3 53 43       ADDD   #$D1C1
E354: 23 F0          BLS    $E328
E356: 60 50          NEG    Illegal Postbyte
E358: EA 25          ORB    $D,X
E35A: 5A             DECB
E35B: 6A FA          DEC    Illegal Postbyte
E35D: EA 89          ORB    $1,X
E35F: 5A             DECB
E360: C0 F0          SUBB   #$D2
E362: 46             RORA
...
E367: 46             RORA
E368: 29 FA          BVS    $E33C
E36A: 6A 5A          DEC    Illegal Postbyte
E36C: EC 29          LDD    $1,X
E36E: 5A             DECB
E36F: 42             XNCA
E370: E9 E6          ADCB   ,U
...
E374: C0 F0          SUBB   #$D2
E376: 46             RORA
E377: 83 FA E2       SUBD   #$D2CA
E37A: 44             LSRA
E37B: 4C             INCA
E37C: 34 FA          PSHS   PC,U,X,A
E37E: 6A 5A          DEC    Illegal Postbyte
E380: E6 23          LDB    $1,X
E382: 50             NEGB
E383: 48             ASLA
E384: EF E6          STU    ,U
...
E38F: 4C             INCA
E390: 28 F0          BVC    $E364
E392: 60 50          NEG    Illegal Postbyte
E394: E6 23          LDB    $1,X
E396: 50             NEGB
E397: 60 FA          NEG    Illegal Postbyte
E399: EC 86          LDD    $E,X
E39B: 5A             DECB
E39C: CA FA          ORB    #$D2
E39E: 4A             DECA
...
E3D8: 45             LSRA
E3D9: 45             LSRA
E3DA: 8E 71 D1       LDX    #$F9F9
E3DD: D0 70          SUBB   $F8
E3DF: 7F D5 D4       CLR    $F7F6
E3E2: 83 65 F7       SUBD   #$E7D5
E3E5: DA 7A          ORB    $F8
E3E7: 75 DF DE       LSR    $F7F6
E3EA: 89 FE          ADCA   #$76
E3EC: FE D0 70       LDU    $F8F8
E3EF: 7F D5 D4       CLR    $F7F6
E3F2: 8B E1          ADDA   #$63
E3F4: F4 DA 7A       ANDB   $F8F8
E3F7: 75 DF DE       LSR    $F7F6
E3FA: 89 A7          ADCA   #$2F
E3FC: FF D0 70       STU    $F8F8
E3FF: 7F D5 D4       CLR    $F7F6
E402: 80 7B          SUBA   #$F9
E404: DB DA          ADDB   $F8
E406: 7A 75 DF       DEC    $F7F7
E409: DE 89          LDU    $01
E40B: 6F CF          CLR    E,S
E40D: FD 70 7F       STD    $F8F7
E410: D5 D4          BITB   $F6
E412: 87 E1          XSTA   #$63
E414: 41             NEGA
E415: F4 7A 75       ANDB   $F8F7
E418: DF DE          STU    $F6
E41A: 89 A7          ADCA   #$2F
E41C: 07 FF          ASR    $D7
E41E: 70 7F D5       NEG    $F7F7
E421: D4 83          ANDB   $01
E423: 7B DB DB       XDEC   $F9F9
E426: 7A 75 DF       DEC    $F7F7
E429: DE 89          LDU    $01
E42B: 61 C1 C1 61    NEG    -$1617,S
E42F: 61 CB CB 94    NEG    -$16EA,S
E433: 7B DB DA       XDEC   $F9F8
E436: 7A 75 DF       DEC    $F7F7
E439: DE A8          LDU    $20
E43B: 89 DE          ADCA   #$F6
E43D: 29 E5          BVS    $E4AC
E43F: 94 D4          ANDA   $F6
E441: 23 6B          BLS    $E42C
E443: 83 D4 02       SUBD   #$F620
E446: 83 74 DE       SUBD   #$F6F6
E449: 29 E5          BVS    $E4B8
E44B: E5 29          BITB   $1,X
E44D: CE 6F 89       LDU    #$E701
E450: D9 41          ADCB   $63
E452: 83 6A 0D       SUBD   #$E82F
E455: 3A             ABX
E456: 74 74 29       LSR    $F601
E459: DE 7E          LDU    $F6
E45B: 89 C1          ADCA   #$E9
E45D: C1 89          CMPB   #$01
E45F: 7E D4 02       JMP    $F620
E462: 74 74 D4       LSR    $F6F6
E465: D4 E1          ANDB   $63
E467: EF 45          STU    $D,S
E469: 45             LSRA
E46A: E5 EB          BITB   $3,S
E46C: CF CF 6F       XSTU   #$E7E7
E46F: 5D             TSTB
E470: 41             NEGA
E471: 41             NEGA
E472: E1 E1          CMPB   $3,S
E474: F4 41 AD       ANDB   $632F
E477: AD 07          JSR    $F,Y
E479: FF EB 7E       STU    $63F6
E47C: DE DE          LDU    $F6
E47E: 7E EB D4       JMP    $63F6
E481: D4 74          ANDB   $F6
E483: 74 41 D4       LSR    $63F6
E486: 74 74 DE       LSR    $F6F6
E489: 4B             XDECA
E48A: 7E 7E DE       JMP    $F6F6
E48D: DE EB          LDU    $63
E48F: 7E D4 D4       JMP    $F6F6
E492: 74 E1 D4       LSR    $63F6
E495: D4 74          ANDB   $F6
E497: 74 4B DE       LSR    $63F6
E49A: 7E 7E DE       JMP    $F6F6
E49D: 4B             XDECA
E49E: 7E 7E D4       JMP    $F6F6
E4A1: D4 E1          ANDB   $63
E4A3: 74 D4 D4       LSR    $F6F6
E4A6: 74 E1 DE       LSR    $63F6
E4A9: DE 7E          LDU    $F6
E4AB: 7E 4B DE       JMP    $63F6
E4AE: 7E 7E D4       JMP    $F6F6
E4B1: 41             NEGA
E4B2: 64 65          LSR    E,S
E4B4: C5 F7          BITB   #$D5
E4B6: E1 79          CMPB   [D,S]
...
E4C3: E1 F4          CMPB   [A,U]
E4C5: 41             NEGA
E4C6: 79 E1 4B       ROL    $6363
E4C9: FE EB 73       LDU    $63FB
E4CC: 5D             TSTB
E4CD: 4B             XDECA
E4CE: 5E             XCLRB
E4CF: EB CA 0D       ADDB   $2F,S
E4D2: AD 55          JSR    [E,U]
E4D4: 41             NEGA
E4D5: D4 74          ANDB   $F6
E4D7: 74 DE 4B       LSR    $F663
E4DA: 7E 7E DE       JMP    $F6F6
E4DD: DE EB          LDU    $63
E4DF: 7E D4 D4       JMP    $F6F6
E4E2: 74 E1 D4       LSR    $63F6
E4E5: D4 74          ANDB   $F6
E4E7: 74 4B DE       LSR    $63F6
E4EA: 7E 7E DE       JMP    $F6F6
E4ED: 4B             XDECA
E4EE: 7E 7E D4       JMP    $F6F6
E4F1: D4 E1          ANDB   $63
E4F3: 74 D4 D4       LSR    $F6F6
E4F6: 74 E1 C1       LSR    $63E9
E4F9: C1 61          CMPB   #$E9
E4FB: 61 4B          NEG    $3,S
E4FD: DE 7E          LDU    $F6
E4FF: 7E D4 41       JMP    $F663
E502: A2 83          SBCA   $1,X
E504: 55             LSRB
E505: 5A             DECB
E506: FB F8 53       ADDB   $7A7B
E509: 54             LSRB
E50A: F5 E9 29       BITB   $6101
E50D: 41             NEGA
E50E: D1 C1          CMPB   $49
E510: 71 59 FE       NEG    $7B7C
E513: FF 43 23       STU    $6101
E516: E8 E1          EORB   $3,S
E518: 62 6E          XNC    $6,U
E51A: CB BB          ADDB   #$33
E51C: 0B 49          XDEC   $61
...
E556: E1 C8          CMPB   $A,U
E558: 6E 6E          JMP    $6,U
E55A: BE F5 49       LDX    $7D61
E55D: 29 E3          BVS    $E5CA
E55F: D3 69          ADDD   $4B
E561: 64 C4          LSR    $6,U
E563: B4 37 43       ANDA   $1561
E566: 83 EE 72       SUBD   #$6C5A
E569: 11 A1 A2       CMPA   $A,Y
E56C: 03 3E          COM    $16
E56E: E9 89          ADCB   $1,X
E570: 55             LSRB
E571: 7F B8 E1       CLR    $3A63
E574: 41             NEGA
E575: 41             NEGA
E576: 95 E3          BITA   $61
E578: 29 5F          BVS    $E5F1
E57A: F0 C6 13       SUBB   $4E3B
E57D: 13             SYNC
E57E: B4 90 43       ANDA   $1861
E581: 23 F5          BLS    $E5FA
E583: FA 52 42       ORB    $7060
E586: D2 FE          SBCB   $7C
E588: 31 49          LEAY   $1,S
E58A: 89 FF          ADCA   #$77
E58C: 4C             INCA
E58D: 7C EB D9       INC    $6351
E590: 5E             XCLRB
E591: 5F             CLRB
E592: E3 81          ADDD   $3,X
E594: 55             LSRB
E595: 5A             DECB
E596: F3 E1 79       ADDD   $6351
E599: 54             LSRB
E59A: F5 E9 29       BITB   $6101
E59D: 5F             CLRB
E59E: EC DC          LDD    -$C,U
E5A0: 41             NEGA
E5A1: 73 FE FF       COM    $7C7D
E5A4: 43             COMA
E5A5: 23 F5          BLS    $E61E
E5A7: FA 5A 4A       ORB    $7262
E5AA: DA F4          ORB    $7C
E5AC: 55             LSRB
E5AD: 49             ROLA
E5AE: 89 FF          ADCA   #$77
E5B0: 5A             DECB
E5B1: 5B             XDECB
E5B2: F8 F9 5E       EORB   $7B7C
E5B5: 5F             CLRB
E5B6: E3 7D 4B 4B    ADDD   [$6363]
E5BA: EB EB          ADDB   $3,S
E5BC: 4B             XDECA
E5BD: 4B             XDECA
E5BE: EB EB          ADDB   $3,S
...
E5CA: 89 3B          ADCA   #$B3
E5CC: 8B 29          ADDA   #$01
E5CE: 38 28          XANDCC #$A0
E5D0: 23 93          BLS    $E583
E5D2: 23 83          BLS    $E5D5
E5D4: 90 80          SUBA   $A2
E5D6: 83 31 8B       SUBD   #$B3A3
E5D9: 29 38          BVS    $E58B
E5DB: 28 29          BVC    $E5DE
E5DD: 99 29          ADCA   $A1
E5DF: 89 90          ADCA   #$B2
...
E5FA: 89 3B          ADCA   #$B3
E5FC: 8B 29          ADDA   #$01
E5FE: 38 28          XANDCC #$A0
E600: 23 93          BLS    $E5B3
E602: 23 83          BLS    $E605
E604: 90 80          SUBA   $A2
E606: 83 31 8B       SUBD   #$B3A3
E609: 29 38          BVS    $E5BB
E60B: 28 29          BVC    $E60E
E60D: 99 29          ADCA   $A1
E60F: 89 90          ADCA   #$B2
...
E62D: A1 0D          CMPA   B,X
E62F: 1A 84          ORCC   #$A6
E631: E2 32 07 B1    SBCB   [-$7A6D,W]
E635: 84 43          ANDA   #$C1
E637: 33 AD          LEAU   B,X
E639: B8 2E 4A       EORA   $A6C2
E63C: 9A AD          ORA    $85
E63E: 19             DAA
E63F: 2E E1          BGT    $E604
E641: 91 07          CMPA   $85
...
E645: 87 27          XSTA   #$A5
E647: 26 BB          BNE    $E5DC
E649: F7 2F 2F       STB    $A7A7
E64C: E7 B8          STB    [,W]
E64E: 2E 01          BGT    $E5D9
E650: AB A7          ADDA   B,X
E652: 13             SYNC
E653: 24 C4          BCC    $E63B
E655: F4 07 10       ANDB   $8592
E658: 8E CF 5F       LDX    #$E7D7
E65B: 0D BB          TST    $93
E65D: 8E 01 01       LDX    #$8989
E660: A7 B2          STA    [,W]
E662: 24 0B          BCC    $E5ED
E664: AB A7          ADDA   B,X
E666: 13             SYNC
...
E669: 8D 2C          BSR    $E60F
E66B: 1A F7          ORCC   #$DF
E66D: 8F 2F 47       XSTX   #$A7CF
E670: B1 84 0B       CMPA   $A689
E673: 0B A7          XDEC   $85
E675: B2 24 46       SBCA   $A6C4
E678: 9C AD          CMPX   $85
E67A: 19             DAA
E67B: 2E ED          BGT    $E642
E67D: 9D 0D          JSR    $85
...
E683: 07 B1          ASR    $93
E685: 84 45          ANDA   #$C7
E687: 35 AD          PULS   CC,B,PC
E689: B8 67 2D       EORA   $EFA5
E68C: 8D 8C          BSR    $E632
E68E: 1A 57          ORCC   #$DF
E690: 85 85          BITA   #$A7
E692: 4D             TSTA
E693: 11 84 AB       ANDA   #$89
E696: 0B 07          XDEC   $85
E698: B8 8E 01       EORA   $A689
E69B: 01 AD          NEG    $85
E69D: B9 2E 70       ADCA   $A6F8
E6A0: CA A7          ORB    #$85
E6A2: 10 24 DB CB    LBCC   $E08F
E6A6: 07 11          ASR    $93
E6A8: 8E A1 01       LDX    #$8989
E6AB: 0D B8          TST    $90
E6AD: C7 2D          XSTB   #$A5
E6AF: 2D 86          BLT    $E655
E6B1: B0 5D 25       SUBA   $DFA7
E6B4: 85 ED          BITA   #$CF
E6B6: 11 24 A1       BCC    $E642
E6B9: A1 0D          CMPA   B,X
E6BB: 18             X18
E6BC: 8E D2 62       LDX    #$FAEA
E6BF: 0D B3          TST    $91
E6C1: 84 79          ANDA   #$FB
E6C3: 69 A7          ROL    B,X
E6C5: A2 83          SBCA   $1,X
E6C7: D9 29          ADCB   $01
E6C9: 74 89 D5       LSR    $015D
E6CC: 29 76          BVS    $E72C
E6CE: 89 98          ADCA   #$10
E6D0: 33 6C          LEAU   $E,U
E6D2: 7D 92 02       TST    $1020
E6D5: 23 62          BLS    $E6B7
E6D7: 6E DC          JMP    [,S]
E6D9: CC 69 6A       LDD    #$E1E2
E6DC: CB 29          ADDB   #$01
E6DE: 68 64 D7       ASL    $E6D6,PCR
E6E1: C7 63          XSTB   #$E1
E6E3: 1A B4          ORCC   #$96
E6E5: 23 62          BLS    $E6C7
E6E7: 62 C8          XNC    ,S+
E6E9: C9 69          ADCB   #$E1
E6EB: 11 BF 22 68    STX    $0AE0
E6EF: 68 C2          ASL    ,S+
E6F1: C3 63 60       ADDD   #$E1E2
E6F4: C1 23          CMPB   #$01
E6F6: 98 62          EORA   $E0
E6F8: C8 C9          EORB   #$E1
E6FA: 69 6A          ROL    ,-S
...
E722: 63 60          COM    ,-S
E724: C1 23          CMPB   #$01
E726: B2 A2 C8       SBCA   $20E0
E729: C9 69          ADCB   #$E1
E72B: 6A CB          DEC    ,--S
E72D: 29 EB          BVS    $E792
E72F: A9 C2          ADCA   ,S+
E731: C3 63 60       ADDD   #$E1E2
E734: C1 23          CMPB   #$01
E736: E1 A3          CMPB   $1,Y
E738: C8 C9          EORB   #$E1
E73A: 69 6A          ROL    ,-S
E73C: CB 29          ADDB   #$01
E73E: B9 A9 C2       ADCA   $21E0
E741: C3 63 60       ADDD   #$E1E2
E744: C1 23          CMPB   #$01
E746: E1 A3          CMPB   $1,Y
E748: C8 C9          EORB   #$E1
E74A: 69 6A          ROL    ,-S
...
E752: 63 60          COM    ,-S
E754: C1 23          CMPB   #$01
E756: B0 A0 C8       SUBA   $22E0
E759: C9 69          ADCB   #$E1
E75B: 6A CB          DEC    ,--S
E75D: 2B 68          BMI    $E73F
E75F: 68 C2          ASL    ,S+
E761: C3 63 60       ADDD   #$E1E2
E764: C1 23          CMPB   #$01
E766: 62 62          XNC    ,S+
E768: C8 C9          EORB   #$E1
E76A: 10 1E CB       EXG    inv,U
E76D: 29 68          BVS    $E74F
E76F: 64 DC          LSR    [W,S]
E771: CC 1B 15       LDD    #$9997
E774: C1 23          CMPB   #$01
E776: 62 6E D7       XNC    $E778,PCR
E779: C7 69          XSTB   #$E1
E77B: 6A CB          DEC    ,--S
E77D: 08 8B          ASL    $03
E77F: 6B 23          XDEC   $1,X
E781: B9 7D 61       ADCA   $FFE3
E784: 02 21          XNC    $03
E786: 61 52          NEG    [,W++]
E788: 29 B2          BVS    $E724
E78A: 58             ASLB
E78B: 77 CB F8       ASR    $E3D0
E78E: A8 85          EORA   $D,X
E790: C2 23          SBCB   #$01
E792: AE 86          LDX    $4,X
E794: 0F 23          CLR    $01
...
E79F: 89 5C          ADCA   #$7E
E7A1: 23 C3          BLS    $E7E4
E7A3: 83 60 24       SUBD   #$4206
E7A6: 62 A2          XNC    $0,Y
E7A8: E8 98 28 18    EORB   [-$5F70,W]
E7AC: A7 E9          STA    ,U++
E7AE: 39             RTS
E7AF: 29 B3          BVS    $E742
E7B1: AD 40          JSR    ,-U
E7B3: 30 80          LEAX   ,-Y
E7B5: B2 0D 41       SBCA   $8FC3
E7B8: 9B 8B          ADDA   $A3
E7BA: 1B             NOP
E7BB: 07 EC          ASR    $C4
E7BD: 9C 2C          CMPX   $A4
...
E7C3: 27 B7          BEQ    $E75A
E7C5: AD 44          JSR    A,U
E7C7: 34 8E          PSHS   PC,Y,D
E7C9: B8 07 4F       EORA   $8FC7
E7CC: 9F 8F          STX    $A7
E7CE: 18             X18
E7CF: 07 EA          ASR    $C8
E7D1: 9A 2A          ORA    $A8
E7D3: 12             NOP
E7D4: AD EB 3B 2B    JSR    -$4657,U
E7D8: B8 A7 42       EORA   $8FCA
E7DB: 32 82          LEAS   F,Y
E7DD: B8 07 43       EORA   $8FCB
E7E0: 99 89          ADCA   $AB
E7E2: 12             NOP
E7E3: 0D EE          TST    $CC
E7E5: 9E 2E          LDX    $AC
E7E7: 1E A7          EXG    A,inv
E7E9: E5 35 25 B5    BITB   [$958A,PCR]
E7ED: A5 46          BITA   W,U
E7EF: 36 8C          PSHU   PC,Y,DP,D
E7F1: BC 0C 4D       CMPX   $8ECF
E7F4: 9D 8D          JSR    $AF
E7F6: 1D             SEX
E7F7: 0D E8          TST    $C0
E7F9: 98 28          EORA   $A0
...
E813: 27 B7          BEQ    $E7AA
E815: AD 44          JSR    A,U
E817: 34 8E          PSHS   PC,Y,D
E819: B8 07 4F       EORA   $8FC7
E81C: 9F 8F          STX    $A7
E81E: 18             X18
E81F: 07 EA          ASR    $C8
E821: 9A 2A          ORA    $A8
E823: 12             NOP
E824: AD EB 3B 2B    JSR    -$4657,U
E828: B8 A7 42       EORA   $8FCA
E82B: 32 82          LEAS   F,Y
E82D: B8 07 43       EORA   $8FCB
E830: 99 89          ADCA   $AB
E832: 12             NOP
E833: 0D EE          TST    $CC
E835: 9E 2E          LDX    $AC
E837: 1E A7          EXG    A,inv
E839: E5 35 25 B5    BITB   [$95DA,PCR]
E83D: A5 46          BITA   W,U
E83F: 36 8C          PSHU   PC,Y,DP,D
E841: BC 0C 4D       CMPX   $8ECF
E844: 9D 8D          JSR    $AF
E846: 1D             SEX
E847: 0D A8          TST    $80
E849: 29 F6          BVS    $E8C9
E84B: F5 55 55       BITB   $7D7D
E84E: E5 84          BITB   $C,X
E850: 5E             XCLRB
E851: 32 92          LEAS   -$10,X
E853: 92 4C          SBCA   $6E
E855: 23 DD          BLS    $E8B6
E857: FD 57 57       STD    $7F7F
E85A: E7 08          STB    ,X+
E85C: 29 56          BVS    $E8DC
E85E: F5 F5 5F       BITB   $7D7D
E861: 5F             CLRB
E862: FF EF 2A       STU    $6D08
E865: 5E             XCLRB
E866: 92 92          SBCA   $10
E868: 38 38          XANDCC #$10
E86A: 98 E6          EORA   $6E
E86C: 29 77          BVS    $E8CD
E86E: F7 F7 5D       STB    $7F7F
E871: 5D             TSTB
E872: FD ED 22       STD    $6F00
E875: 60 78          NEG    [F,S]
E877: 68 F7 E7 37    ASL    [$CFBF]
E87B: 35 85          PULS   CC,B,DP,Y,PC
E87D: 58             ASLB
E87E: 89 72          ADCA   #$FA
E880: C8 88          EORB   #$AA
E882: 4D             TSTA
E883: 3D             MUL
E884: 9F 8F          STX    $AD
E886: F2 86 D2       SBCB   $04FA
E889: C2 57          SBCB   #$DF
E88B: 47             ASRA
E88C: 97 95          STA    $BD
E88E: 25 F8          BCS    $E900
E890: 23 D8          BLS    $E88C
E892: 68 7E CE       ASL    [$E881,PCR]
E895: 9D 3F          JSR    $BD
E897: 2F 58          BLE    $E909
E899: 29 72          BVS    $E895
E89B: 62 D5 C5 37    XNC    [$D65E,PCR]
E89F: 35 8F          PULS   CC,B,DP,Y,PC
E8A1: 52             XNCB
E8A2: 83 78 C8       SUBD   #$FAEA
E8A5: DC 6C          LDD    $EE
E8A7: 3D             MUL
E8A8: 95 85          BITA   $AD
E8AA: F8 89 D2       EORB   $01FA
E8AD: C2 77          SBCB   #$FF
E8AF: 67 9D 9F 2F    ASR    [$BDAD]
E8B3: F2 23 D8       SBCB   $01FA
E8B6: 68 67          ASL    B,S
E8B8: FD 97 35       STD    $BFBD
E8BB: 25 58          BCS    $E92D
E8BD: 23 72          BLS    $E8B9
E8BF: 62 89          XNC    D,Y
E8C1: ED 3D 3F 8F    STD    [$BDAD]
E8C5: 52             XNCB
E8C6: 83 78 C2       SUBD   #$FAEA
E8C9: 84 7E          ANDA   #$F6
E8CB: 7B D8 85       XDEC   $F0AD
E8CE: F8 89 D8       EORB   $01FA
E8D1: C8 39          EORB   #$BB
E8D3: 75 D6 D3       LSR    $F4F1
E8D6: 2F F2          BLE    $E948
E8D8: 2A D2          BPL    $E8D4
E8DA: 62 57 E7 DC    XNC    [$CFF4]
E8DE: 79 25 52       ROL    $AD70
E8E1: 23 78          BLS    $E8DD
E8E3: 68 9E DA       ASL    [$E8DE,PCR]
E8E6: 76 73 85       ROR    $F1AD
E8E9: 58             ASLB
E8EA: 89 72          ADCA   #$FA
E8EC: C2 50          SBCB   #$78
E8EE: 71 7D D0       NEG    $F5F2
E8F1: 8F F2 80       XSTX   #$7002
E8F4: D8 C8          EORB   $EA
E8F6: 29 4D          BVS    $E8C7
E8F8: 97 95          STA    $BD
E8FA: 25 F8          BCS    $E96C
...
E8FE: 62 5F          XNC    [E,U]
E900: 98 9B          EORA   $B9
E902: 35 36          PULS   B,X,Y,PC
E904: 52             XNCB
E905: 23 78          BLS    $E901
E907: 65 F0 92       LSR    [-$46,U]
E90A: 61 98          NEG    -$10,X
E90C: 9D 58          JSR    $70
E90E: 89 72          ADCA   #$FA
E910: CA FA          ORB    #$D8
E912: 38 6B          XANDCC #$E9
E914: 32 97          LEAS   [B,Y]
E916: F2 83 D2       SBCB   $01FA
E919: C0 50          SUBB   #$D8
E91B: 32 F6          LEAS   [W,U]
E91D: 90 3E          SUBA   $B6
E91F: F8 23 D8       EORB   $01FA
E922: 6A 5A 98       DEC    [-$46,U]
E925: 9D 3F          JSR    $BD
E927: 2F 58          BLE    $E999
E929: 29 72          BVS    $E925
E92B: 60 F0 A6       NEG    [-$72,U]
E92E: 26 52          BNE    $E90A
E930: 9C 52          CMPX   $70
E932: 83 78 CA       SUBD   #$FAE8
E935: FA 5E 2D       ORB    $DCAF
E938: 67 8E          ASR    A,Y
E93A: F8 89 D2       EORB   $01FA
E93D: C0 50          SUBB   #$D8
E93F: 40             NEGA
E940: 32 F9          LEAS   [D,U]
E942: 16 06 23       LBRA   $6D46
E945: D8 6A          EORB   $E8
E947: 5A             DECB
E948: E0 38          SUBB   -$10,X
E94A: 53             COMB
E94B: 1D             SEX
E94C: AD 29          JSR    $1,X
E94E: 72 60 FA       XNC    $E8D8
E951: EA 92          ORB    -$10,X
E953: 59             ROLB
E954: B6 A4 83       LDA    $8601
E957: 78 C0 F0       ASL    $E8D8
E95A: 40             NEGA
E95B: 98 F3          EORA   $DB
E95D: BD 2C 89       JSR    $A401
E960: D8 CA          EORB   $E8
E962: 5A             DECB
E963: 4A             DECA
E964: 32 F9          LEAS   [D,U]
E966: 16 27 29       LBRA   $8E6A
E969: D2 60          SBCB   $E8
E96B: 50             NEGB
E96C: 57             ASRB
E96D: 55             LSRB
E96E: E5 55 52 2A    BITB   [$1597A,PCR]
E972: 78 6A FA       ASL    $E8D8
E975: 98 3D          EORA   $BF
E977: 3F             SWI
E978: 85 58          BITA   #$70
E97A: 89 72          ADCA   #$FA
E97C: C0 F0          SUBB   #$D8
E97E: 41             NEGA
E97F: 37 9F          PULU   CC,B,DP,X,Y,PC
E981: 8F F2 83       XSTX   #$7001
E984: D8 CA          EORB   $E8
E986: 5B             XDECB
E987: 4D             TSTA
E988: 97 95          STA    $BD
E98A: 25 F8          BCS    $E9FC
E98C: 29 D2          BVS    $E988
E98E: 63 57 ED 9D    COM    [$CFBF]
E992: 3F             SWI
E993: 2F 52          BLE    $EA05
E995: DD 78          STD    $FA
E997: 68 F7 E7 37    ASL    [$CFBF]
E99B: 35 85          PULS   CC,B,DP,Y,PC
E99D: 58             ASLB
E99E: 86 89          LDA    #$01
E9A0: 92 82          SBCA   $A0
E9A2: 83 33 83       SUBD   #$B1A1
E9A5: 23 30          BLS    $E959
E9A7: 20 29          BRA    $E9AA
E9A9: 9B 2B          ADDA   $A3
E9AB: 89 98          ADCA   #$B0
E9AD: 88 89          EORA   #$01
E9AF: 39             RTS
E9B0: 83 23 30       SUBD   #$01B2
E9B3: 20 23          BRA    $E9B6
E9B5: 91 21          CMPA   $A3
E9B7: 83 98 88       SUBD   #$B0A0
E9BA: 89 39          ADCA   #$B1
E9BC: 89 29          ADCA   #$01
E9BE: 3A             ABX
E9BF: 2A 23          BPL    $E9C2
E9C1: 91 21          CMPA   $A3
E9C3: 83 92 82       SUBD   #$B0A0
E9C6: 83 33 89       SUBD   #$B1A1
E9C9: 29 3A          BVS    $E97D
E9CB: 2A 29          BPL    $E9CE
E9CD: 9B 2B          ADDA   $A3
E9CF: 89 92          ADCA   #$B0
...
E9DD: 88 89          EORA   #$01
E9DF: 39             RTS
E9E0: 83 23 30       SUBD   #$01B2
E9E3: 20 23          BRA    $E9E6
E9E5: 91 21          CMPA   $A3
E9E7: 83 98 88       SUBD   #$B0A0
E9EA: 89 39          ADCA   #$B1
E9EC: 89 29          ADCA   #$01
E9EE: 3A             ABX
E9EF: 2A 23          BPL    $E9F2
E9F1: 91 21          CMPA   $A3
E9F3: 83 92 82       SUBD   #$B0A0
E9F6: 83 33 89       SUBD   #$B1A1
E9F9: 29 3A          BVS    $E9AD
E9FB: 2A 29          BPL    $E9FE
E9FD: 9B 2B          ADDA   $A3
E9FF: 89 92          ADCA   #$B0
...
EA0D: 88 89          EORA   #$01
EA0F: 39             RTS
EA10: 83 23 30       SUBD   #$01B2
EA13: 20 23          BRA    $EA16
EA15: 91 21          CMPA   $A3
EA17: 83 98 88       SUBD   #$B0A0
EA1A: 89 39          ADCA   #$B1
EA1C: 89 29          ADCA   #$01
EA1E: 3A             ABX
EA1F: 2A 23          BPL    $EA22
EA21: 91 21          CMPA   $A3
EA23: 83 92 82       SUBD   #$B0A0
EA26: 83 33 89       SUBD   #$B1A1
EA29: 29 3A          BVS    $E9DD
EA2B: 2A 29          BPL    $EA2E
EA2D: 9B 2B          ADDA   $A3
EA2F: 89 92          ADCA   #$B0
...
EA3D: 88 89          EORA   #$01
EA3F: 39             RTS
EA40: 83 23 30       SUBD   #$01B2
EA43: 20 23          BRA    $EA46
EA45: 91 21          CMPA   $A3
EA47: 83 98 88       SUBD   #$B0A0
EA4A: 89 39          ADCA   #$B1
EA4C: 89 29          ADCA   #$01
EA4E: 3A             ABX
EA4F: 2A 23          BPL    $EA52
EA51: 91 21          CMPA   $A3
EA53: 83 92 82       SUBD   #$B0A0
EA56: 83 33 89       SUBD   #$B1A1
EA59: 29 3A          BVS    $EA0D
EA5B: 2A 29          BPL    $EA5E
EA5D: 9B 2B          ADDA   $A3
EA5F: 08 B2          ASL    $90
...
EA70: 84 AB          ANDA   #$89
EA72: 0B 07          XDEC   $85
EA74: B2 84 40       SBCA   $A6C2
EA77: 30 AD          LEAX   B,X
EA79: B9 2E 4B       ADCA   $A6C3
EA7C: 9B AD          ADDA   $85
EA7E: 1A 2E          ORCC   #$A6
EA80: AB AB 07 11    ADDA   -$7A6D,X
EA84: 84 E6          ANDA   #$C4
EA86: 36 07          PSHU   PC,B,CC
EA88: B8 8E 4D       EORA   $A6C5
EA8B: 3D             MUL
EA8C: AD B9          JSR    [,X++]
EA8E: 2E 01          BGT    $EA19
EA90: AB A7          ADDA   B,X
EA92: 10 24 AB AB    LBCC   $741F
EA96: 07 11          ASR    $93
EA98: 8E D0 60       LDX    #$F8E8
EA9B: 0D B8          TST    $90
EA9D: 8E 71 61       LDX    #$F9E9
EAA0: A7 B3          STA    [,X++]
EAA2: 24 0B          BCC    $EA2D
EAA4: AB A7          ADDA   B,X
EAA6: 10 24 EE 9E    LBCC   $B160
EAAA: 0D 1B          TST    $93
EAAC: 8E EF 3F       LDX    #$C7B7
EAAF: 0D B2          TST    $90
EAB1: 84 0B          ANDA   #$89
EAB3: 0B A7          XDEC   $85
EAB5: B3 24 78       SUBD   $A6FA
EAB8: C2 AD          SBCB   #$85
EABA: 1A 2E          ORCC   #$A6
EABC: D3 C3          ADDD   $EB
EABE: 0D 1B          TST    $93
EAC0: 84 AB          ANDA   #$89
EAC2: 0B 07          XDEC   $85
EAC4: B2 84 0B       SBCA   $A689
EAC7: 0B AD          XDEC   $85
EAC9: BA 2E 6E       ORA    $A6E6
EACC: FE AD 1B       LDU    $8593
EACF: 2E C5          BGT    $EAB8
EAD1: F5 07 12       BITB   $8590
EAD4: 84 AB          ANDA   #$89
EAD6: 0B 07          XDEC   $85
EAD8: B9 8E 01       ADCA   $A689
EADB: 01 AD          NEG    $85
EADD: BA 2E 4A       ORA    $A6C2
EAE0: 90 A7          SUBA   $85
EAE2: 11 24 E1       BCC    $EAA8
EAE5: 91 07          CMPA   $85
EAE7: 12             NOP
EAE8: 8E A1 01       LDX    #$8989
EAEB: 0D BA          TST    $92
EAED: 8E 4E 3E       LDX    #$C6B6
EAF0: A7 B1          STA    [,--X]
EAF2: 24 45          BCC    $EABB
EAF4: 95 A7          BITA   $85
EAF6: 12             NOP
...
EAF9: A1 0D          CMPA   B,X
EAFB: 19             DAA
EAFC: 8E A1 01       LDX    #$8989
EAFF: 0D B0          TST    $92
EB01: 84 42          ANDA   #$C0
EB03: 32 A7          LEAS   B,X
EB05: B1 24 43       CMPA   $A6C1
EB08: E9 AD          ADCB   B,X
EB0A: 18             X18
EB0B: 2E A1          BGT    $EA96
EB0D: A1 0D          CMPA   B,X
...
EB10: 84 AB          ANDA   #$89
EB12: 0B 07          XDEC   $85
EB14: B0 84 0B       SUBA   $A689
EB17: 0B AD          XDEC   $85
EB19: BB 2E 01       ADDA   $A689
EB1C: A1 AD          CMPA   B,X
EB1E: 18             X18
EB1F: 2E AB          BGT    $EAAA
EB21: AB 07          ADDA   B,X
...
EB24: 84 AB          ANDA   #$89
EB26: 0B 07          XDEC   $85
EB28: BA 8E 01       ORA    $A689
EB2B: 01 AD          NEG    $85
EB2D: BB 2E 01       ADDA   $A689
EB30: AB A7          ADDA   B,X
EB32: 12             NOP
EB33: 24 AB          BCC    $EABE
EB35: AB 07          ADDA   B,X
EB37: 13             SYNC
EB38: 8E A1 01       LDX    #$8989
EB3B: 0D BA          TST    $92
EB3D: 8E 01 01       LDX    #$8989
EB40: A7 B1          STA    [,--X]
EB42: 24 0B          BCC    $EACD
EB44: AB A7          ADDA   B,X
EB46: 12             NOP
...
EB49: A1 0D          CMPA   B,X
EB4B: 19             DAA
EB4C: 8E A1 01       LDX    #$8989
EB4F: 0D B0          TST    $92
EB51: 84 0B          ANDA   #$89
EB53: 0B A7          XDEC   $85
EB55: B1 24 0B       CMPA   $A689
EB58: A1 AD          CMPA   B,X
EB5A: 18             X18
EB5B: 2E A1          BGT    $EAE6
EB5D: A1 0D          CMPA   B,X
...
EB60: 84 AB          ANDA   #$89
EB62: 0B 07          XDEC   $85
EB64: B0 84 0B       SUBA   $A689
EB67: 0B AD          XDEC   $85
EB69: BB 2E 01       ADDA   $A689
EB6C: A1 AD          CMPA   B,X
EB6E: 18             X18
EB6F: 2E AB          BGT    $EAFA
EB71: AB 07          ADDA   B,X
...
EB74: 84 AB          ANDA   #$89
EB76: 0B 07          XDEC   $85
EB78: BA 8E 01       ORA    $A689
EB7B: 01 AD          NEG    $85
EB7D: BB 2E 01       ADDA   $A689
EB80: AB A7          ADDA   B,X
EB82: 12             NOP
EB83: 24 AB          BCC    $EB0E
EB85: AB 07          ADDA   B,X
EB87: 13             SYNC
EB88: 8E A1 01       LDX    #$8989
EB8B: 0D BA          TST    $92
EB8D: 8E 01 01       LDX    #$8989
EB90: A7 B1          STA    [,--X]
EB92: 24 0B          BCC    $EB1D
EB94: AB A7          ADDA   B,X
EB96: 12             NOP
...
EB99: A1 0D          CMPA   B,X
EB9B: 19             DAA
EB9C: 8E A1 01       LDX    #$8989
EB9F: 0D 23          TST    $01
EBA1: DB 7B          ADDB   $F9
EBA3: 74 4A 4B       LSR    $6869
EBA6: FA FA 50       ORB    $7878
EBA9: 50             NEGB
EBAA: E2 F0          SBCB   -$8,S
EBAC: 50             NEGB
EBAD: DF 71          STU    $F9
EBAF: 71 02 03       NEG    $2021
EBB2: A3 A3          SUBD   $1,Y
EBB4: 03 03          COM    $21
EBB6: A3 A3          SUBD   $1,Y
EBB8: 09 09          ROL    $21
EBBA: A9 A9          ADCA   $1,Y
EBBC: 09 09          ROL    $21
EBBE: AA 71 DB 23    ORA    [-$06FF,S]
EBC2: 7B 7B 12       XDEC   $F930
EBC5: B3 10 11       SUBD   $9293
EBC8: BC BD 1E       CMPX   $9596
EBCB: 1F 84          TFR    CC,inv
EBCD: F6 BA 71       LDB    $32F9
EBD0: DB 12          ADDB   $30
EBD2: 88 92          EORA   #$10
EBD4: 39             RTS
EBD5: 3D             MUL
EBD6: 9C 93          CMPX   $11
EBD8: 35 31          PULS   CC,DP,X
EBDA: 98 89          EORA   $01
EBDC: 21 20          BRN    $EBE6
EBDE: 8C BA DB       CMPX   #$32F9
EBE1: DB 83          ADDB   $01
EBE3: 7B DB 62       XDEC   $F940
EBE6: E5 EA          BITB   $8,S
EBE8: 56             RORB
EBE9: 69 C9          ROL    $1,U
EBEB: C9 4F          ADCB   #$67
EBED: 40             NEGA
EBEE: F6 CA DB       LDB    $42F9
EBF1: DB C2          ADDB   $40
EBF3: C3 45 4A       ADDD   #$6768
EBF6: FC C3 69       LDD    $4141
EBF9: 69 C9          ROL    $1,U
EBFB: C9 4F          ADCB   #$67
EBFD: 40             NEGA
EBFE: F6 C9 60       LDB    $4142
EC01: DB 7B          ADDB   $F9
EC03: 83 DB DB       SUBD   #$F9F9
EC06: 7B 7B D1       XDEC   $F9F9
EC09: D1 A8          CMPB   $20
EC0B: A9 09          ADCA   $1,Y
EC0D: 09 A9          ROL    $21
EC0F: A9 03          ADCA   $1,Y
...
EC1B: A9 09          ADCA   $1,Y
EC1D: 0A 71          DEC    $F9
EC1F: 71 DB DB       NEG    $F9F9
EC22: 7B 7B 27       XDEC   $F905
EC25: DB 7B          ADDB   $F9
EC27: 7B D1 D1       XDEC   $F9F9
EC2A: 71 B8 4B       NEG    $3063
EC2D: 4B             XDECA
EC2E: EB EB          ADDB   $3,S
EC30: 41             NEGA
EC31: 41             NEGA
...
EC3C: 4B             XDECA
EC3D: 4B             XDECA
EC3E: BA 71 DB       ORA    $F9F9
EC41: DB 7B          ADDB   $F9
EC43: 7B DB 23       XDEC   $F901
EC46: 7B 7B D1       XDEC   $F9F9
EC49: D1 71          CMPB   $F9
EC4B: 71 68 69       NEG    $4041
EC4E: C9 C9          ADCB   #$41
EC50: 63 45          COM    $7,S
EC52: EA FC          ORB    -$2,S
EC54: 63 63          COM    $1,U
EC56: C3 C3 4F       ADDD   #$4167
EC59: 40             NEGA
EC5A: F6 C9 69       LDB    $4141
EC5D: 69 C9          ROL    $1,U
EC5F: CA DB          ORB    #$F9
EC61: DB 7B          ADDB   $F9
EC63: 7B DB DB       XDEC   $F9F9
EC66: 83 7B D1       SUBD   #$F9F9
EC69: D1 71          CMPB   $F9
EC6B: 71 D1 D1       NEG    $F9F9
EC6E: 71 71 DB       NEG    $F9F9
EC71: DB 7B          ADDB   $F9
EC73: 7B DB DB       XDEC   $F9F9
EC76: 7B 7B D1       XDEC   $F9F9
EC79: D1 71          CMPB   $F9
EC7B: 71 D1 D1       NEG    $F9F9
EC7E: 71 71 DB       NEG    $F9F9
EC81: DB 7B          ADDB   $F9
EC83: 7B DB DB       XDEC   $F9F9
EC86: 7B 83 DE       XDEC   $01F6
EC89: 40             NEGA
EC8A: E1 F0          CMPB   -$8,S
EC8C: 50             NEGB
EC8D: 50             NEGB
EC8E: F0 E2 5A       SUBB   $6A78
EC91: 5A             DECB
EC92: FA FA 49       ORB    $786B
EC95: 4E             XCLRA
EC96: E9 F8          ADCB   -$6,S
EC98: 50             NEGB
EC99: 50             NEGB
EC9A: F0 F0 50       SUBB   $7878
EC9D: 50             NEGB
EC9E: F0 F0 5A       SUBB   $7878
ECA1: 5A             DECB
ECA2: FA FA 5A       ORB    $7878
ECA5: 5A             DECB
ECA6: FA 75 29       ORB    $F701
ECA9: 18             X18
ECAA: 19             DAA
ECAB: 1A BB          ORCC   #$93
ECAD: BC 1D 1E       CMPX   $9596
ECB0: B5 FC 0A       BITA   $DE88
ECB3: 1A BB          ORCC   #$99
ECB5: B8 19 1E       EORA   $9B9C
ECB8: B5 D4 75       BITA   $FCFD
ECBB: 98 22          EORA   $0A
ECBD: 33 97          LEAU   -$1,X
ECBF: 96 33          LDA    $11
ECC1: 3F             SWI
...
ECD0: 4A             DECA
ECD1: 5C             INCB
ECD2: C3 C3 63       ADDD   #$4141
ECD5: 63 C3          COM    $1,U
ECD7: C3 69 69       ADDD   #$4141
ECDA: C9 C9          ADCB   #$41
ECDC: 69 69          ROL    $1,U
ECDE: C9 C9          ADCB   #$41
ECE0: 63 63          COM    $1,U
...
ECE4: 5C             INCB
ECE5: 63 C3          COM    $1,U
ECE7: C3 69 6A       ADDD   #$4142
ECEA: 02 3F          XNC    $B7
ECEC: A3 49          SUBD   $1,S
ECEE: 03 F1          COM    $79
ECF0: AD 5D          JSR    -$1,S
ECF2: 08 19          ASL    $9B
ECF4: A8 AB A9 0B    EORA   $2B89,X
ECF8: 81 90          CMPA   #$B8
ECFA: 23 B3          BLS    $ED37
ECFC: A3 B3          SUBD   [D,X]
ECFE: 23 13          BLS    $EC9B
ED00: A8 0B          EORA   $9,Y
ED02: A1 30          CMPA   Illegal Postbyte
ED04: B0 09 03       SUBA   $2B81
ED07: 20 AB          BRA    $EC8C
ED09: 9A 82          ORA    $0A
ED0B: 39             RTS
ED0C: 10 BA 08 23    ORA    $80AB
ED10: 9A 98          ORA    $BA
ED12: 3A             ABX
ED13: 29 A9          BVS    $ECA0
ED15: A8 3A B9       EORA   [$3B,Y]
ED18: 2A 09          BPL    $ED3B
ED1A: 9B A9          ADDA   $21
ED1C: 1A 2B          ORCC   #$03
ED1E: 21 A0          BRN    $ED48
...
ED77: 8B 39          ADDA   #$11
ED79: 19             DAA
ED7A: B8 8D 3B       EORA   $0513
ED7D: 37 AB          PULU   CC,A,Y
ED7F: 99 31          ADCA   $13
ED81: 00 A0          NEG    $22
ED83: 8D 31          BSR    $ED98
ED85: 08 9E          ASL    event_pointer_1c
ED87: 8B 3B          ADDA   #$13
ED89: 19             DAA
ED8A: A5 8D          BITA   $5,X
ED8C: 3D             MUL
ED8D: 37 96          PULU   D,DP,X
ED8F: 99 37          ADCA   $15
ED91: 07 98          ASR    $1A
ED93: 8C 37 0B       CMPX   #$1529
ED96: 9E 8B          LDX    $09
ED98: 3D             MUL
ED99: 01 A0          NEG    $28
ED9B: 8C 3F 0A       CMPX   #$1722
ED9E: 91 99          CMPA   $11
EDA0: 35 07          PULS   CC,B,Y
EDA2: 9A 8C          ORA    $0E
EDA4: 35 07          PULS   CC,B,Y
EDA6: 98 8B          EORA   $09
EDA8: 3F             SWI
EDA9: 00 AF          NEG    $27
EDAB: 8C 31 09       CMPX   #$1921
EDAE: 9F 98          STX    $10
EDB0: 3B             RTI
EDB1: 06 94          ROR    $16
EDB3: 8C 3B 0B       CMPX   #$1929
EDB6: 95 85          BITA   $07
EDB8: 31 00          LEAY   $8,Y
EDBA: AE 8C          LDX    $4,X
EDBC: 09 34          ROL    event_pointer_1c
EDBE: 90 99          SUBA   $11
EDC0: 03 3D          COM    $1F
EDC2: 9B 8B          ADDA   $09
EDC4: 03 0B          COM    $29
...
EDDC: 0D 08          TST    $20
EDDE: 9B 87          ADDA   $0F
EDE0: 07 3E          ASR    event_pointer_1c
EDE2: 9B 8A          ADDA   $08
EDE4: 07 07          ASR    $25
EDE6: 95 8A          BITA   $08
EDE8: 0D 1B          TST    $33
...
EE21: 3D             MUL
EE22: 96 8C          LDA    $0E
EE24: 11 34 97       PSHS   X,B,CC
EE27: 8A 1B          ORA    #$33
EE29: 0D 94          TST    event_pointer_1c
EE2B: 8C 1D 3D       CMPX   #$3515
EE2E: 9C 98          CMPX   $10
EE30: 17 3B 97       LBSR   $0748
EE33: 8C 17 3B       CMPX   #$3519
EE36: 98 8A          EORA   $08
EE38: 1D             SEX
EE39: 0B 9B          XDEC   $13
EE3B: 8D 1F          BSR    $EE74
...
EE48: 1F 01          TFR    Y,B
EE4A: 9F 8C          STX    $04
EE4C: 11 3C 9D       CWAI   #$15
EE4F: 8F 1B 3A       XSTX   #$3918
EE52: 97 8C          STA    $0E
EE54: 1B             NOP
EE55: 06 97          ROR    $15
EE57: 8A 11          ORA    #$39
EE59: 00 9F          NEG    $17
EE5B: 8C 69 0F       CMPX   #$4127
EE5E: 92 98          SBCA   $10
EE60: 63 04          COM    $6,Y
EE62: 95 8C          BITA   $0E
EE64: 63 04          COM    $6,Y
...
EE7C: 48             ASLA
EE7D: D5 E8          BITB   $60
EE7F: 76 42 DD       ROR    $60FF
EE82: E2 7C          SBCB   [W,S]
EE84: DD B0          STD    $92
EE86: 0D 10          TST    $92
EE88: B6 BC B9       LDA    $9431
EE8B: 1D             SEX
EE8C: 97 BE          STA    $96
EE8E: C0 1E          SUBB   #$96
EE90: F0 00 93       SUBB   $2211
EE93: 9C 39          CMPX   $1B
EE95: 3B             RTI
EE96: 9C 95          CMPX   $17
EE98: 28 22          BVC    $EEA4
...
EEC4: 33 00          LEAU   $2,Y
EEC6: 97 92          STA    $10
EEC8: 36 37          PSHU   X,DP,D,CC
EECA: AC 98          CMPX   -$10,X
EECC: 0A 39          DEC    $11
EECE: 96 93          LDA    $1B
EED0: 37 36          PULU   B,X
EED2: 94 A0          ANDA   $22
EED4: 37 37          PULU   CC,B,X
EED6: 92 A2          SBCA   $20
EED8: 34 39          PSHS   X,CC
EEDA: A1 9B          CMPA   -$D,X
EEDC: 37 36          PULU   D,DP,X
EEDE: 9F AA          STX    $22
EEE0: 33 06          LEAU   $4,Y
EEE2: A7 9E          STA    -$4,X
EEE4: 33 06          LEAU   $4,Y
EEE6: 9B 9D          ADDA   $1F
EEE8: 36 01          PSHU   Y,DP,CC
EEEA: 97 AD          STA    $25
EEEC: 38 39          XANDCC #$11
EEEE: AA 9D          ORA    -$B,X
EEF0: 32 06          LEAS   $4,Y
EEF2: 9A 97          ORA    $15
EEF4: 32 35          LEAS   -$9,X
...
EF0D: 63 CA          COM    $2,U
EF0F: CB 22          ADDB   #$00
EF11: 7C DD D4       INC    $5F56
EF14: 75 B4 7B       LSR    $96F9
EF17: 15             XHCF
EF18: 13             SYNC
EF19: B1 51 02       CMPA   $D98A
EF1C: 05 0A          LSR    $22
EF1E: 46             RORA
EF1F: AB 6F          ADDA   $D,U
EF21: 01 0E          NEG    $8C
...
EF47: A6 BC          LDA    [,X]
EF49: 0C 9E          INC    $16
EF4B: AB B0 0B       ADDA   [$23,X]
EF4E: 1E AB          EXG    Y,U
EF50: B6 01 10       LDA    $2392
EF53: A1 73          CMPA   -$F,U
EF55: 00 52          NEG    $D0
EF57: A0 67          SUBA   $F,U
EF59: 98 F0          EORA   $78
EF5B: 28 A8          BVC    $EEDD
EF5D: B8 00 00       EORA   $8888
EF60: B2 AA 22       SBCA   $88A0
EF63: 0A 92          DEC    $B0
EF65: AA 42          ORA    ,U+
EF67: FA 98 40       ORB    $B068
EF6A: 28 D0          BVC    $EFC4
EF6C: B8 60 10       EORA   $4898
EF6F: B0 82 0A       SUBA   $A028
EF72: 2A B2          BPL    $EFA4
EF74: BA 1A 0A       ORA    $3888
EF77: CA 50          ORB    #$78
EF79: 10 E0 B8       SUBB   -$10,Y
EF7C: 70 00 C0       NEG    $2848
EF7F: B0 72 6A       SUBA   $5048
EF82: DA DA          ORB    $58
EF84: 42             XNCA
EF85: 4A             DECA
EF86: D2 FA          SBCB   $78
EF88: 68 A0 B8       ASL    $30,X
EF8B: 00 68          NEG    $40
EF8D: A0 D8          SUBA   -$10,U
EF8F: 00 42          NEG    $60
EF91: B2 EA 22       SBCA   $68A0
EF94: 52             XNCB
EF95: 30 A7          LEAX   $5,Y
EF97: A6 0C          LDA    $4,Y
EF99: 37 96          PULU   D,DP,X
EF9B: 88 29          EORA   #$01
EF9D: 2E 8B          BGT    $EFA2
EF9F: 8C 28 DD       CMPX   #$0AFF
EFA2: 50             NEGB
EFA3: 92 F1          SBCA   $D3
EFA5: F6 92 57       LDB    $10D5
EFA8: F8 F9 98       EORB   $D110
EFAB: 58             ASLB
EFAC: F9 38 58       ADCB   $10D0
EFAF: 59             ROLB
EFB0: C2 C3          SBCB   #$E1
EFB2: 92 62          SBCA   $E0
EFB4: C3 32 62       ADDD   #$10E0
EFB7: 63 B2          COM    [F,X]
EFB9: 32 12          LEAS   [F,X]
EFBB: 15             XHCF
EFBC: B3 02 28       SUBD   $2AA0
EFBF: DC 8B          LDD    $A9
EFC1: BA F5 E7       ORA    $7765
EFC4: 76 61 A3       ROR    $4321
EFC7: 92 81          SBCA   $A9
EFC9: B0 FF ED       SUBA   $7765
EFCC: 7C 6B A9       INC    $4321
EFCF: 98 BB          EORA   $99
EFD1: AA F5          ORA    -$9,S
EFD3: E7 76          STB    -$C,U
EFD5: 11 A3 92       CMPU   -$10,X
EFD8: B0 A0 FE       SUBA   $8876
EFDB: ED 6C          STD    $4,U
EFDD: 6B A9          XDEC   $1,Y
EFDF: 98 AA          EORA   $88
EFE1: A5 F4          BITA   -$A,S
EFE3: E7 66          STB    $4,U
EFE5: 10 A3 92       CMPD   -$10,X
EFE8: A0 5F          SUBA   -$9,S
EFEA: EE DD          LDU    -$B,U
EFEC: 6C 1A          INC    -$E,Y
EFEE: A9 98          ADCA   -$10,X
EFF0: 55             LSRB
EFF1: 55             LSRB
EFF2: E4 D6          ANDB   -$C,U
EFF4: 61 10          NEG    -$E,Y
...
F001: 44             LSRA
F002: D7 D6          STB    $54
F004: 11 00 93       NEG    $11
F007: 82 4E          SBCA   #$66
F009: 7D DD CC       TST    $5544
F00C: 1B             NOP
F00D: 0A 99          DEC    $11
F00F: 88 77          EORA   #$55
F011: 77 C6 C1       ASR    $4443
F014: 11 00 92       NEG    $10
F017: 82 7D          SBCA   #$55
F019: 6C CC          INC    $4,U
F01B: CB 1A          ADDB   #$32
F01D: 09 98          ROL    $10
F01F: 88 66          EORA   #$44
F021: 66 C1          ROR    $3,U
F023: B1 00 33       CMPA   $2211
F026: 92 82          SBCA   game_playing_00
F028: 6C 1B          INC    -$D,Y
F02A: BB BA 0A       ADDA   $3222
F02D: 39             RTS
F02E: 88 88          EORA   #$00
F030: 11             FCB    $11
F031: 11 B0 A0 03    SUBA   $2221
F035: 32 82          LEAS   $0,X
F037: 82 1B          SBCA   #$33
F039: 1A AA          ORCC   #$22
F03B: AA 39          ORA    -$F,X
...
F04F: 88 33          EORA   #$11
F051: 33 93          LEAU   -$F,X
F053: 92 22          SBCA   game_playing_00
F055: 22 82          BHI    $F057
F057: 82 39          SBCA   #$11
F059: 39             RTS
F05A: 88 88          EORA   #$00
...
F060: 62 65          XNC    $7,U
F062: CA 7D          ORB    #$FF
F064: FA 4E CA       ORB    $6C48
F067: B4 03 0C       ANDA   $2B24
F06A: 96 77          LDA    $FF
F06C: F0 44 C0       SUBB   $6C48
F06F: BE 09 06       LDX    $2B24
F072: 9C A5          CMPX   $27
F074: 3B             RTI
F075: 3C 96          CWAI   #$14
F077: 92 0B          SBCA   $23
...
F0AA: 14             XHCF
F0AB: 15             XHCF
F0AC: B6 B7 87       LDA    $9F0F
F0AF: 87 88          XSTA   #$AA
F0B1: 89 2E          ADCA   #$AC
F0B3: 2F 8C          BLE    $F063
F0B5: 8D 8D          BSR    $F0C6
F0B7: 0E A5          JMP    $8D
F0B9: B5 34 35       BITA   $BCBD
F0BC: 96 97          LDA    $BF
F0BE: 04 05          LSR    $8D
F0C0: BF BF 4E       STX    $9DCC
F0C3: 4F             CLRA
F0C4: EC ED          LDD    ,W++
F0C6: 5A             DECB
F0C7: 5B             XDECB
F0C8: F2 F3 54       SBCB   $DBDC
F0CB: 55             LSRB
F0CC: F6 F7 60       LDB    $DFE8
F0CF: 61 C8          NEG    F,S
F0D1: C9 6E          ADCB   #$EC
F0D3: 6F CC          CLR    W,S
F0D5: CD             XHCF
F0D6: 7A 7B D2       DEC    $F9FA
F0D9: D3 74          ADDD   $FC
F0DB: 75 D6 D7       LSR    $FEFF
F0DE: 87 09          XSTA   #$81
F0E0: A0 A1          SUBA   ,--X
F0E2: 12             NOP
F0E3: 13             SYNC
F0E4: B0 B1 8D       SUBA   $930F
F0E7: 20 8B          BRA    $F08C
F0E9: 27 3A          BEQ    $F09D
F0EB: 3B             RTI
F0EC: 52             XNCB
F0ED: 38 90          XANDCC #$18
F0EF: A1 02          CMPA   $0,Y
F0F1: 37 A0          PULU   A,Y
F0F3: 92 3F          SBCA   $1D
F0F5: 37 96          PULU   B,X
F0F7: 93 34          SUBD   event_pointer_1c
F0F9: 31 AB          LEAY   $3,Y
F0FB: AC 38          CMPX   -$10,X
F0FD: 52             XNCB
F0FE: 99 9A          ADCA   $12
F100: 31 36          LEAY   -$C,X
F102: 97 95          STA    $17
F104: 22 22          BHI    $F106
F106: 83 80 2B       SUBD   #$0203
F109: 2C 8D          BGE    $F110
F10B: 88 28          EORA   #$00
F10D: 38 99          XANDCC #$11
F10F: 9A 31          ORA    $13
F111: 36 82          PSHU   
F113: 82 02          SBCA   #$20
F115: 03 A0          COM    $22
F117: A1 0C          CMPA   $4,Y
F119: 28 B8          BVC    $F14B
F11B: B9 1A 1B       ADCA   $3233
F11E: BC 88 22       CMPX   >$0000
F121: A9 C2          ADCA   $0,U
F123: C3 60 61       ADDD   #$4243
F126: C6 82          LDB    #$00
F128: 78 79 DA       ASL    $5152
F12B: DB 7C          ADDB   $54
F12D: 7D 88 E8       TST    >$0060
F130: 43             COMA
F131: 72 E0 79       XNC    $62FB
F134: 41             NEGA
F135: BA F2 F3       ORA    $7071
F138: 5A             DECB
F139: 5B             XDECB
F13A: 63 FD          COM    -$B,S
F13C: 28 83          BVC    $F0E9
F13E: 8E 8F 2A       LDX    #$0708
F141: 2B 88          BMI    $F14D
F143: 82 37          SBCA   #$15
F145: 34 95          PSHS   X,D,CC
F147: 9A 31          ORA    $19
F149: 32 88          LEAS   $0,X
F14B: AD 0E          JSR    $6,Y
F14D: 0F A0          CLR    $28
F14F: A1 08          CMPA   $A,Y
F151: 22 B7          BHI    $F188
F153: B4 15 1A       ANDA   $3738
F156: BB B8 6D       ADDA   $3A45
F159: 6E CF          JMP    $7,U
F15B: C0 61          SUBB   #$49
F15D: 62 C3          XNC    $B,U
F15F: C4 6F          ANDB   #$4D
...
F169: AE 0F          LDX    E,X
F16B: 00 7E          NEG    $56
F16D: 7F D0 D1       CLR    $5859
F170: 78 79 DE       ASL    $5B5C
F173: DF 7C          STU    $5E
F175: DD 59          STD    $DB
F177: 1E B5          EXG    B,inv
F179: B6 17 38       LDA    $9FB0
F17C: BD BE 1F       JSR    $9697
F17F: 88 46          EORA   #$64
F181: 47             ASRA
F182: E4 E5          ANDB   $7,S
F184: 4A             DECA
...
F198: 51             NEGB
F199: 52             XNCB
F19A: F3 F4 55       ADDD   $7C7D
F19D: B1 13 34       CMPA   $9BBC
F1A0: 9F 9C          STX    $BE
F1A2: 3D             MUL
F1A3: 36 97          PSHU   PC,Y,X,B,CC
F1A5: 94 35          ANDA   $B7
F1A7: 82 23          SBCA   #$0B
F1A9: 24 85          BCC    $F1B8
F1AB: 86 27          LDA    #$0F
...
F1AE: E5 E6          BITB   $E,S
F1B0: 4D             TSTA
F1B1: 7D 06 4E       TST    $84CC
F1B4: EF EC          STU    W,U
F1B6: 4D             TSTA
F1B7: 55             LSRB
F1B8: F0 F1 70       SUBB   $D9F8
F1BB: 88 33          EORA   #$1B
F1BD: 34 95          PSHS   X,DP,B,CC
F1BF: 96 3D          LDA    $1F
F1C1: 5C             INCB
F1C2: FD 02 A3       STD    $8081
F1C5: A0 01          SUBA   ,--X
F1C7: 5E             XCLRB
F1C8: F5 F6 57       BITB   $DEDF
F1CB: 6F C0 C1       CLR    -$17,S
F1CE: 02 88          XNC    game_playing_00
F1D0: B8 09 AE       EORA   $2B2C
F1D3: AF 0C          STX    $E,Y
F1D5: 0D 12          TST    $90
F1D7: 13             SYNC
F1D8: BA BB 3B       ORA    $93B3
F1DB: 64 C5 80 67    LSR    $9ACE,PCR
F1DF: 7F CC DB       CLR    $EEF9
F1E2: 0B 82          XDEC   game_playing_00
F1E4: 56             RORB
F1E5: 19             DAA
F1E6: BE BF 16       LDX    $3D3E
F1E9: 17 29 2A       LBSR   $938E
F1EC: 8B 9A          ADDA   #$B2
F1EE: 72 74 DF       XNC    $FCFD
F1F1: DC 82          LDD    game_playing_00
F1F3: 44             LSRA
F1F4: E5 88          BITB   F,Y
F1F6: 82 82          SBCA   #$00
F1F8: 29 D1          BVS    $F1F3
...
F213: A3 03          SUBD   $1,Y
F215: 03 A3          COM    $21
F217: A0 D1 29 71    SUBA   [$01F9,S]
F21B: B8 F8 F9       EORA   $D0D1
F21E: 5A             DECB
F21F: 5B             XDECB
F220: F6 F7 54       LDB    $D5D6
F223: 72 D3 D0       XNC    $F1F2
F226: 74 7B D1       LSR    $F9F9
F229: D1 B8          CMPB   $30
F22B: 82 38          SBCA   #$10
F22D: 33 97          LEAU   -$1,X
F22F: 96 33          LDA    $11
...
F23E: E0 F6          SUBB   -$2,S
F240: 63 63          COM    $1,U
F242: C3 64 45       ADDD   #$E667
F245: 4A             DECA
F246: FC 66 D1       LDD    $E4F9
F249: D1 71          CMPB   $F9
F24B: C8 69          EORB   #$41
F24D: 4F             CLRA
F24E: E0 F6          SUBB   -$2,S
F250: 63 63          COM    $1,U
F252: C3 C3 63       ADDD   #$4141
F255: 45             LSRA
F256: EA FC          ORB    -$2,S
F258: 69 6A          ROL    $2,U
F25A: 71 6B EA       NEG    $E3C2
F25D: EA 4B          ORB    ,--U
F25F: 7B D6 D7       XDEC   $F4F5
F262: 74 21 B8       LSR    $A39A
F265: 81 38          CMPA   #$BA
F267: 27 AC          BEQ    $F1ED
F269: 8D 45          BSR    $F238
F26B: 2D D6          BLT    $F26B
...
F27D: 3D             MUL
F27E: AB 93          ADDA   -$5,X
F280: 37 37          PULU   CC,B,X
F282: A6 92          LDA    -$10,X
F284: 01 3A          NEG    $18
F286: 9D 9D          JSR    $1F
F288: 0C 31          INC    $19
F28A: 96 9F          LDA    $17
F28C: 34 37          PSHS   X,DP,D,CC
F28E: 96 9F          LDA    $17
F290: 32 3A          LEAS   -$8,X
F292: 9D A0          JSR    $22
F294: 01 37          NEG    $15
...
F2A1: 3E             XRES
F2A2: 97 92          STA    $10
F2A4: 38 07          XANDCC #$25
F2A6: 9F A2          STX    $20
F2A8: 0F 3D          CLR    $15
F2AA: 91 9F          CMPA   $17
F2AC: 30 0C          LEAX   $4,Y
F2AE: 98 94          EORA   event_pointer_1c
F2B0: 3B             RTI
F2B1: 34 A6          PSHS   Y,B
F2B3: 9B 3C          ADDA   $1E
F2B5: 35 A2          PULS   Y
F2B7: 9D 34          JSR    event_pointer_1c
F2B9: 3D             MUL
F2BA: 98 AE          EORA   $26
F2BC: 39             RTS
F2BD: 0D 94          TST    event_pointer_1c
F2BF: AC 21          CMPX   $3,X
F2C1: 23 84          BLS    $F2C9
F2C3: 87 22          XSTA   #$00
F2C5: 26 80          BNE    $F2C9
F2C7: F8 38 0C       EORB   $1024
F2CA: 97 9C          STA    $14
F2CC: 39             RTS
F2CD: 01 AB          NEG    $23
F2CF: 98 30          EORA   $12
F2D1: 37 A1          PULU   CC,A,Y
F2D3: A6 32          LDA    -$10,X
F2D5: 23 82          BLS    $F2D7
F2D7: 92 52          SBCA   $7A
F2D9: 0F 97          CLR    $1F
...
F2ED: 0A 9D          DEC    $15
F2EF: 9D 32          JSR    $10
F2F1: 02 9E          XNC    event_pointer_1c
F2F3: 93 0B          SUBD   $29
F2F5: 22 88          BHI    $F301
F2F7: 80 2E          SUBA   #$06
F2F9: 29 8B          BVS    $F2FE
...
F309: 85 10          BITA   #$98
F30B: 26 67          BNE    $F35C
F30D: 8E 6C 20       LDX    #$E4A8
F310: A0 8B 11 2B    SUBA   -$6C57,Y
F314: FF 88 0D       STU    $AA8F
F317: 83 28 2D       SUBD   #$0005
F31A: 88 89          EORA   #$01
F31C: 28 2D          BVC    $F323
F31E: 88 89          EORA   #$01
F320: 23 22          BLS    $F322
...
F324: 23 27          BLS    $F32B
F326: 82 97          SBCA   #$15
F328: 35 1E          PULS   D,X,Y
F32A: FC 95 35       LDD    $1D1D
F32D: 33 93          LEAU   -$5,X
F32F: 61 2C          NEG    $E,X
F331: C6 94          LDB    #$16
F333: 64 36          LSR    -$C,X
F335: D4 8C          ANDB   $0E
F337: 82 2C          SBCA   #$04
F339: D0 88          SUBB   game_playing_00
F33B: 80 28          SUBA   #$00
F33D: 2E 88          BGT    $F33F
F33F: C8 62          EORB   #$40
F341: 62 C2          XNC    $0,U
...
F345: 68 D7          ASL    -$B,U
F347: D4 7F          ANDB   $57
F349: 70 C8 C8       NEG    $4040
F34C: 68 68          ASL    $0,U
F34E: B8 C8 43       EORA   $4061
F351: 40             NEGA
F352: E1 ED          CMPB   $F,S
F354: 42             XNCA
F355: 6A 86          DEC    $4,X
F357: 84 A1          ANDA   #$89
F359: A1 01 00 A0    CMPA   -$7778,X
F35D: A1 00 00       CMPA   -$78,X
F360: AB AA 0A       ADDA   -$78,X
F363: 0B AA          XDEC   $88
F365: AA 0B 2D D7    ORA    -$5001,X
F369: 28 88          BVC    $F36B
F36B: 89 2A          ADCA   #$02
F36D: 2C 8D          BGE    $F374
F36F: 7B 83 D6       XDEC   $A1F4
F372: B5 76 77       BITA   $F455
F375: D6 F1          LDB    $73
F377: 76 31 DB       ROR    $19F3
F37A: 73 7B F5       COM    $F3DD
F37D: DB 37          ADDB   $BF
F37F: 7B 83 D1       XDEC   $A1F3
F382: 01 7F          NEG    $FD
F384: 2A 22          BPL    $F386
F386: 7F 92 28       CLR    $1000
F389: D5 90          BITB   $18
F38B: 88 D5          EORA   #$FD
F38D: 08 88          ASL    game_playing_00
F38F: 75 0A 22       LSR    $2800
F392: 7F B2 22       CLR    $3000
F395: DF BA          STU    $38
F397: 82 D5          SBCA   #$FD
F399: 68 88          ASL    $0,X
F39B: 75 60 28       LSR    $4800
F39E: 75 D8 22       LSR    $5000
F3A1: DC 85          LDD    $07
F3A3: 83 22 2D       SUBD   #$000F
F3A6: 83 81 3E       SUBD   #$0316
F3A9: 29 8D          BVS    $F3B0
F3AB: 96 29          LDA    $01
F3AD: 20 AD          BRA    $F3D4
F3AF: 89 28          ADCA   #$0A
F3B1: 0F 83          CLR    $01
F3B3: 8F 16 23       XSTX   #$3401
F3B6: 8D BE          BSR    $F3F4
F3B8: 29 3A          BVS    $F3CC
F3BA: CB 89          ADDB   #$01
F3BC: 3C 63          CWAI   #$4B
...
F3D4: 00 10          NEG    $32
F3D6: 80 A5          SUBA   #$27
F3D8: 10 2A A4 B6    LBPL   $201A
F3DC: 2A 28          BPL    $F3DE
F3DE: 8E 8C 24       LDX    #$0406
F3E1: 29 81          BVS    $F3E6
F3E3: 8E 2D 26       LDX    #$0F04
F3E6: 90 96          SUBA   $14
F3E8: 2B 30          BMI    $F402
F3EA: 90 8C          SUBA   $04
F3EC: 36 35          PSHU   X,DP,B,CC
F3EE: 8B AC          ADDA   #$24
F3F0: 03 26          COM    $04
F3F2: A8 A4          EORA   $6,Y
F3F4: 21 12          BRN    $F426
F3F6: A8 86          EORA   $4,X
F3F8: 1E 07          EXG    Y,inv
F3FA: 8B 88          ADDA   #$00
F3FC: 2D 2D          BLT    $F403
F3FE: 8F 8F 27       XSTX   #$0705
F401: 2D 8B          BLT    $F40C
F403: 87 34          XSTA   #$16
F405: 29 87          BVS    $F40C
F407: 9C 25          CMPX   dsw2_copy_0d
F409: 2D AD          BLT    $F430
F40B: 87 2D          XSTA   #$05
F40D: 05 99          LSR    $11
F40F: 8D 16          BSR    $F445
F411: 31 87          LEAY   $5,X
F413: BE 37 27       LDX    $1505
F416: C1 95          CMPB   #$17
F418: 2D 28          BLT    $F41A
F41A: 8C 8E 20       CMPX   #$0608
F41D: 2C 8E          BGE    $F425
F41F: 98 26          EORA   $04
F421: 24 9A          BCC    $F43B
F423: 86 24          LDA    #$06
...
F427: 84 00          ANDA   #$28
F429: 2C 8E          BGE    $F431
F42B: B8 2C 2E       EORA   $0406
F42E: B0 8C 24       SUBA   $0406
F431: 62 86          XNC    $4,X
F433: 84 6A          ANDA   #$48
F435: 26 84          BNE    $F43D
F437: 82 2F          SBCA   #$07
...
F456: 87 87          XSTA   #$05
F458: 2F 20          BLE    $F462
F45A: 8C 86 24       CMPX   #$0E0C
F45D: 2C 9D          BGE    $F474
F45F: 99 21          ADCA   $03
F461: 39             RTS
F462: 94 81          ANDA   $03
F464: 03 3E          COM    event_pointer_1c
F466: 81 A4          CMPA   #$26
F468: 0A 2A          DEC    $02
F46A: A1 A1          CMPA   $9,Y
F46C: 29 03          BVS    $F499
F46E: A7 89          STA    $1,X
F470: 0F 17          CLR    $35
F472: 83 82 20       SUBD   #$0002
F475: 2A 85          BPL    $F47E
F477: 7D 2F 27       TST    $070F
F47A: 76 8E 3F       ROR    $0617
F47D: D6 8E          LDB    $06
F47F: 96 22          LDA    game_playing_00
F481: 27 A7          BEQ    $F4A8
F483: 81 27          CMPA   #$05
F485: 0E 85          JMP    $07
F487: 86 1A          LDA    #$32
F489: 24 8B          BCC    $F48E
F48B: B0 3A 2B       SUBA   $1203
F48E: B6 90 21       LDA    $1803
F491: 22 8C          BHI    $F4A1
F493: A3 03          SUBD   $1,Y
F495: 22 82          BHI    $F497
F497: 80 2B          SUBA   #$03
F499: 2A 8B          BPL    $F49E
F49B: 8C 2F 20       CMPX   #$0708
F49E: 81 83          CMPA   #$0B
F4A0: 2D 34          BLT    $F4B8
F4A2: A3 A3          SUBD   $1,Y
F4A4: 03 03          COM    $21
...
F4E2: 92 92          SBCA   $10
F4E4: 2D 2D          BLT    $F4F5
F4E6: 8C 8F 25       CMPX   #$0D0D
F4E9: 26 86          BNE    $F4F9
F4EB: 87 38          XSTA   #$10
F4ED: 39             RTS
F4EE: 9A 9A          ORA    $12
F4F0: 33 32          LEAU   -$10,X
F4F2: 8D A3          BSR    $F515
F4F4: 03 03          COM    $21
F4F6: A3 A3          SUBD   $1,Y
F4F8: 09 09          ROL    $21
F4FA: A9 95          ADCA   -$3,X
F4FC: 35 34          PULS   B,DP,X
F4FE: 93 92          SUBD   $1A
F500: 3B             RTI
F501: 35 94          PULS   D,X
F503: 89 22          ADCA   #$00
F505: 22 82          BHI    $F507
F507: 83 29 2A       SUBD   #$0102
F50A: 8C 8D 2E       CMPX   #$0506
F50D: 2F A9          BLE    $F530
F50F: A9 03          ADCA   $1,Y
F511: 03 A3          COM    $21
F513: A3 03          SUBD   $1,Y
...
F534: C6 95          LDB    #$B7
F536: 0A 38          DEC    $BA
F538: B6 92 6E       LDA    $BAE6
F53B: 32 D1 92 86    LEAS   [-$45F2,S]
F53F: 3B             RTI
F540: CE 96 EE       LDU    #$B46C
F543: 36 C0          PSHU   PC,S,Y,A
F545: 97 10          STA    $92
F547: 37 DF          PULU   CC,D,X,Y,S,PC
F549: 9E ED          LDX    $65
F54B: 3E             XRES
F54C: 2B 9F          BMI    $F505
F54E: E3 88          ADDD   $0,X
F550: 26 DD          BNE    $F551
F552: 7E 7D 22       JMP    $FF00
F555: 23 82          BLS    $F557
F557: 82 29          SBCA   #$01
F559: 2A 8B          BPL    $F55E
F55B: 8C 2D 2C       CMPX   #$0504
F55E: 8F 8F 24       XSTX   #$0706
F561: 24 8E          BCC    $F56F
F563: 84 2E          ANDA   #$0C
F565: 23 87          BLS    $F56C
F567: 82 29          SBCA   #$01
...
F577: 80 2C          SUBA   #$04
F579: 28 8A          BVC    $F57D
F57B: 8E 28 68       LDX    #$0040
F57E: C8 D0          EORB   #$58
F580: 79 64 CE       ROL    $464C
F583: DB 62          ADDB   $40
F585: 62 C2          XNC    $0,U
F587: C2 68          SBCB   #$40
F589: 68 C8          ASL    $0,U
...
F59C: 68 68          ASL    $0,U
F59E: C8 D0          EORB   #$58
F5A0: 79 60 C3       ROL    $4241
F5A3: CC 76 63       LDD    #$5441
F5A6: CF C2 68       XSTU   #$4040
F5A9: 68 C8          ASL    $0,U
F5AB: C8 68          EORB   #$40
F5AD: 68 C8          ASL    $0,U
F5AF: C8 13          EORB   #$31
F5B1: 14             XHCF
F5B2: B7 C2 9E       STA    $40BC
F5B5: 62 C2          XNC    $0,U
F5B7: C2 68          SBCB   #$40
F5B9: 68 C8          ASL    $0,U
F5BB: C8 68          EORB   #$40
...
F63F: D0 79          SUBB   $5B
F641: 6A C7          DEC    $5,U
F643: C3 74 7B       ADDD   #$5659
F646: C2 C2          SBCB   #$40
F648: 68 68          ASL    $0,U
F64A: C8 C8          EORB   #$40
F64C: 68 68          ASL    $0,U
F64E: C8 C8          EORB   #$40
F650: 10 16 B2 C2    LBRA   $2694
F654: 9E 62          LDX    $40
F656: C2 C2          SBCB   #$40
F658: 68 68          ASL    $0,U
F65A: C8 C8          EORB   #$40
F65C: 68 68          ASL    $0,U
F65E: C8 D0          EORB   #$58
F660: 79 71 D7       ROL    $5355
F663: D2 67          SBCB   $45
F665: 70 C2 CA       NEG    $4048
F668: 6D 69          TST    $1,U
F66A: DE D1          LDU    $59
F66C: 68 68          ASL    $0,U
F66E: C8 C8          EORB   #$40
F670: 10 14          XHCF
F672: B2 C2 9E       SBCA   $40BC
F675: 62 C2          XNC    $0,U
F677: C2 68          SBCB   #$40
F679: 68 C8          ASL    $0,U
F67B: C8 68          EORB   #$40
...
F6A4: 53             COMB
F6A5: 4A             DECA
F6A6: F2 80 5B       SBCB   $0273
F6A9: 4A             DECA
F6AA: 8F FD 4C       XSTX   #$7564
F6AD: 2B F3          BMI    $F72A
F6AF: D5 20          BITB   $02
F6B1: 57             ASRB
F6B2: E3 80          ADDD   $2,X
...
F6CE: E8 8C          EORB   $4,X
F6D0: 4D             TSTA
F6D1: 77 82 F6       ASR    >$0074
F6D4: 42             XNCA
F6D5: 23 0F          BLS    $F664
F6D7: DF 40          STU    $68
F6D9: 47             ASRA
F6DA: 88 FF          EORA   #$77
F6DC: 74 2A E0       LSR    $0268
F6DF: FC 22 55       LDD    >$0077
F6E2: E3 80          ADDD   $2,X
F6E4: 5C             INCB
F6E5: 47             ASRA
F6E6: 83 15 4A       SUBD   #$9762
F6E9: 68 78          ASL    [,--W]
F6EB: C8 D9          EORB   #$F1
F6ED: 48             ASLA
F6EE: 48             ASLA
F6EF: E8 EA 42       EORB   $60,U
F6F2: 57             ASRB
F6F3: E2 FF 42 52    SBCB   [$157C7,PCR]
F6F7: E2 F0 BA       SBCB   [-$6E,U]
F6FA: 40             NEGA
F6FB: 1A F0          ORCC   #$D8
F6FD: AD 48          JSR    ,U+
F6FF: FD E2 A7       STD    $C085
F702: 52             XNCB
F703: F7 F2 A7       STB    $D085
F706: 62 F7          XNC    -$B,S
F708: C8 28          EORB   #$00
F70A: 8C 80 24       CMPX   #$080C
F70D: 29 8D          BVS    $F714
F70F: 81 2F          CMPA   #$0D
F711: 20 84          BRA    $F719
F713: 88 2C          EORA   #$0E
...
F717: 89 27          ADCA   #$0F
F719: 14             XHCF
F71A: B7 C9 6A       STA    $4142
F71D: 6B CC          XDEC   $4,U
F71F: CD             XHCF
F720: 64 65          LSR    $7,U
F722: CA CB          ORB    #$49
F724: 68 69          ASL    $B,U
F726: CE CF 66       LDU    #$4D4E
F729: 28 8A          BVC    $F72D
F72B: 8D 2F          BSR    $F734
F72D: 22 84          BHI    $F73B
F72F: 85 2C          BITA   #$0E
...
F773: 87 25          XSTA   #$07
F775: 28 8E          BVC    $F783
F777: 8F 26 28       XSTX   #$0E00
F77A: 8A 8D          ORA    #$05
F77C: 2F 22          BLE    $F788
F77E: 84 85          ANDA   #$0D
F780: 2C 20          BGE    $F784
F782: 8E 8F 2C       LDX    #$0D0E
F785: 2D 8D          BLT    $F796
F787: 8D 27          BSR    $F798
F789: 28 8A          BVC    $F78D
F78B: 8D 2F          BSR    $F794
...
F79E: 87 87          XSTA   #$0F
F7A0: 2D 28          BLT    $F7AC
F7A2: 8E 8F 2C       LDX    #$0D0E
F7A5: 2D 8D          BLT    $F7B6
F7A7: 8D 27          BSR    $F7B8
F7A9: D3 8E          ADDD   $06
F7AB: 73 20 D5       COM    $08FD
F7AE: 82 77          SBCA   #$FF
F7B0: 2E 23          BGT    $F7B3
F7B2: 8C 80 2C       CMPX   #$020E
F7B5: 27 8D          BEQ    $F7C6
F7B7: 8A 26          ORA    #$0E
F7B9: 21 86          BRN    $F7C9
F7BB: 83 24 25       SUBD   #$0C0D
F7BE: 82 87          SBCA   #$0F
F7C0: 2A 2D          BPL    $F7D1
F7C2: 84 8D          ANDA   #$0F
F7C4: 21 2F          BRN    $F7D3
F7C6: 83 89 D7       SUBD   #$0BFF
F7C9: 21 75          BRN    $F7C8
F7CB: 80 D5          SUBA   #$FD
F7CD: 2D 74          BLT    $F7CB
F7CF: 8A DF          ORA    #$FD
F7D1: 23 7F          BLS    $F7D0
F7D3: 7D DD DF       TST    $FFFD
F7D6: 83 79 2B       SUBD   #$FB03
F7D9: 95 14          BITA   $9C
F7DB: 35 B4          PULS   B,DP,X,PC
F7DD: 95 3F          BITA   $B7
F7DF: 35 BE          PULS   B,DP,X,PC
F7E1: 9F 1E          STX    $9C
F7E3: 3F             SWI
F7E4: 87 9F          XSTA   #$BD
F7E6: 42             XNCA
F7E7: 3F             SWI
F7E8: E8 95 2D 35    EORB   [$9DA9,PCR]
F7EC: E8 95 14 35    EORB   [$94AD,PCR]
F7F0: BE 9F 2C       LDX    $BDAE
F7F3: A8 00          EORA   $2,Y
F7F5: 07 A3          ASR    $21
F7F7: A1 2F          CMPA   $7,X
F7F9: DA 8A          ORB    $02
F7FB: 8A DD          ORA    #$F5
F7FD: 2D 8F          BLT    $F806
F7FF: 7D 20 20       TST    $0202
F802: 7A 87 2A       DEC    $0508
F805: D5 80          BITB   $02
F807: 81 D2          CMPA   #$FA
F809: 2D 8E          BLT    $F811
F80B: 71 2A 29       NEG    $0201
F80E: 74 8D 9C       LSR    $05BE
F811: 83 3D 85       SUBD   #$BF07
F814: 9C F6          CMPX   $D4
F816: EA ED          ORB    $F,S
F818: 28 5F          BVC    $F891
F81A: D4 8A          ANDB   $02
...
F81D: 4D             TSTA
F81E: 88 0D          EORA   #$85
F820: 7A 37 03       DEC    $1581
F823: D6 20          LDB    $02
F825: A4 DD          ANDA   -$1,U
F827: 88 A4          EORA   #$8C
F829: 4B             XDECA
F82A: 83 0E 77       SUBD   #$865F
F82D: 2E 0E          BGT    $F7B5
F82F: EE 2F          LDU    $D,X
F831: 4A             DECA
F832: ED 82          STD    $0,X
F834: 55             LSRB
F835: 7E 80 FC       JMP    $027E
F838: 4D             TSTA
F839: 2A 0E          BPL    $F7C1
F83B: D2 3F          SBCB   $17
F83D: A8 D0          EORA   -$8,U
F83F: 8B A4          ADDA   #$86
F841: 7E 8D 09       JMP    $0F8B
F844: 7A 28 04       DEC    $0A86
F847: DE 3C          LDU    $14
F849: AC D0          CMPX   -$8,U
F84B: 82 40          SBCA   #$68
F84D: 47             ASRA
...
F86F: AB 0A          ADDA   $8,Y
F871: 0E B3          JMP    $31
F873: B7 1B 1C       STA    $393E
F876: C0 C4          SUBB   #$46
F878: 63 67          COM    $F,U
F87A: DB DF          ADDB   $57
F87C: 73 48 EC       COM    $6064
F87F: E0 4E          SUBB   $C,S
F881: 52             XNCB
F882: F6 FA 5E       LDB    $787C
F885: 5D             TSTB
F886: 01 05          NEG    $87
F888: A3 A7          SUBD   ,W
F88A: 1A 1E          ORCC   #$96
F88C: B1 B5 28       CMPA   $9DA0
F88F: 2C 85          BGE    $F838
F891: 89 2C          ADCA   #$AE
F893: 33 96          LEAU   [,Y]
F895: 95 38          BITA   $BA
...
F89E: 59             ROLB
F89F: 5B             XDECB
F8A0: F4 FA 59       ANDB   $D8DB
F8A3: 5F             CLRB
F8A4: FD C3 61       STD    $E1E3
F8A7: 67 CF          ASR    E,S
F8A9: C1 63          CMPB   #$EB
F8AB: 64 C6          LSR    W,S
F8AD: D8 79          EORB   $F1
F8AF: 7B D6 D7       XDEC   $F4F5
F8B2: 74 75 DA       LSR    $F7F8
F8B5: DB 78          ADDB   $FA
F8B7: 79 D4 D5       ROL    $FCFD
F8BA: 75 76 D6       LSR    $FEFE
F8BD: D6 77          LDB    $FF
F8BF: 77 DD DD       ASR    $FFFF
F8C2: 83 80 26       SUBD   #$0204
F8C5: 20 80          BRA    $F8C9
F8C7: 80 29          SUBA   #$01
F8C9: 22 82          BHI    $F8D5
F8CB: 98 38          EORA   $10
F8CD: 38 9C          XANDCC #$14
F8CF: 82 25          SBCA   #$07
F8D1: 32 9B          LEAS   -$7,X
F8D3: 92 2C          SBCA   $0E
F8D5: E3 D7          ADDD   -$B,U
...
F8DB: 4A             DECA
F8DC: A3 EB          SUBD   ,--U
F8DE: BD 4B 17       JSR    $C335
F8E1: E1 A5          CMPB   $7,Y
F8E3: 41             NEGA
F8E4: B8 E1 A5       EORA   $C327
F8E7: 41             NEGA
F8E8: 1D             SEX
F8E9: EB BD          ADDB   -$B,Y
F8EB: 4B             XDECA
F8EC: 74 EC 90       LSR    $C418
F8EF: 4C             INCA
F8F0: 47             ASRA
F8F1: E1 18          CMPB   [F,X]
F8F3: 41             NEGA
...
F8F9: 89 07          ADCA   #$8F
F8FB: 03 E3          COM    $CB
F8FD: E4 45 46 ED    ANDB   $C7D0,PCR
F901: F2 53 46       SBCB   $D1C4
F904: F9 E7 08       ADCB   $C58A
F907: 47             ASRA
F908: 80 ED          SUBA   #$C5
F90A: 74 4E FE       LSR    $C6D6
F90D: 75 81 C0       LSR    $0948
F910: B8 6A 2C       EORA   $48AE
F913: 47             ASRA
F914: B4 E5 90       ANDA   $C712
F917: 45             LSRA
F918: 07 EF          ASR    $C7
F91A: A7 4F          STA    E,U
F91C: 07 EF          ASR    $C7
F91E: A7 EC          STA    $4,S
F920: 5E             XCLRB
F921: 76 E2 CE       ROR    $604C
F924: BE 23 85       LDX    $0107
F927: 80 26          SUBA   #$0E
F929: 2B 9D          BMI    $F940
F92B: 8C 34 2C       CMPX   #$1C04
F92E: AB 8C          ADDA   $4,X
F930: DD E5          STD    $C7
F932: E3 45          ADDD   E,U
F934: 9D E5          JSR    $C7
...
F937: 45             LSRA
F938: 97 EF          STA    $C7
F93A: 37 4F          PULU   CC,D,S,PC
F93C: EF EF          STU    E,U
F93E: 74 40 59       LSR    $C87B
F941: EA FC          ORB    -$2,S
F943: 4A             DECA
F944: C0 EA          SUBB   #$C8
F946: 7D 4B 1E       TST    $C936
F949: E1 C5          CMPB   $D,U
F94B: 41             NEGA
F94C: A6 E1 1B 41    LDA    -$6C37,U
F950: 81 EB          CMPA   #$C9
F952: 27 4B          BEQ    $F91D
F954: F4 E8 FB       ANDB   $CA79
F957: 48             ASLA
F958: B0 E2 BB       SUBA   $CA33
F95B: 42             XNCA
F95C: 40             NEGA
F95D: E2 F1          SBCB   -$7,S
F95F: 42             XNCA
F960: BA DB EB       ORA    $F969
F963: 7B 51 DB       XDEC   $73F9
F966: FF 7B 55       STU    $F97D
F969: D1 0F          CMPB   $87
F96B: 71 A5 D1       NEG    $8DF9
F96E: 1B             NOP
F96F: 71 BB DB       NEG    $99F9
F972: 1B             NOP
F973: 7B BD DB       XDEC   $9FF9
F976: 27 7B          BEQ    $F971
F978: 83 D1 39       SUBD   #$F9B1
F97B: 71 99 D1       NEG    $B1F9
F97E: 3F             SWI
F97F: 71 9F DB       NEG    $BDF9
F982: 41             NEGA
F983: 7B EB DB       XDEC   $C9F9
F986: 4D             TSTA
F987: C0 69          SUBB   #$41
F989: 68 80          ASL    $8,X
F98B: 8B 68          ADDA   #$40
...
F9D5: 12             NOP
F9D6: 52             XNCB
F9D7: B2 0C 68       SBCA   $2440
F9DA: 48             ASLA
F9DB: C8 1C          EORB   #$34
F9DD: 1E 98          EXG    X,D
F9DF: BE 02 14       LDX    $2036
F9E2: B2 B4 62       SBCA   $3640
F9E5: 12             NOP
F9E6: 22 B3          BHI    $FA19
F9E8: 28 19          BVC    $FA1B
F9EA: E8 B9          EORB   -$F,Y
F9EC: E8 68          EORB   $0,U
F9EE: C3 C2 61       ADDD   #$4A43
F9F1: 60 C2          NEG    $0,U
F9F3: DD 7C          STD    $5E
F9F5: 75 D4 92       LSR    $5610
F9F8: 38 D7          XANDCC #$FF
F9FA: 71 65 D1       NEG    $EDF9
F9FD: DF 72          STU    $FA
F9FF: 9D D8          JSR    $FA
FA01: 38 78          XANDCC #$FA
FA03: D9 D8          ADCB   $FA
FA05: 42             XNCA
FA06: C2 00          SBCB   #$82
FA08: 46             RORA
...
FA1A: 88 14          EORA   #$9C
FA1C: 46             RORA
FA1D: BC E6 98       CMPX   $6E10
FA20: 32 DD 78 98    LEAS   [$FA1A]
FA24: D8 02          EORB   $20
FA26: 22 B2          BHI    $FA58
FA28: 19             DAA
FA29: 10 B1 28 1C    CMPA   $A034
FA2D: 1D             SEX
FA2E: B4 B5 42       ANDA   $3D60
FA31: 0B AA          XDEC   $28
FA33: A3 02          SUBD   $0,Y
FA35: 42             XNCA
FA36: AF AE          STX    $C,Y
...
FA3A: E8 B1          EORB   -$7,Y
FA3C: 10 19          DAA
FA3E: B8 E8 1F       EORA   $603D
FA41: 1E B7          EXG    U,PC
FA43: B6 42 6B       LDA    $6049
FA46: CA C3          ORB    #$41
FA48: 68 88          ASL    ,Y+
FA4A: AC AD          CMPX   $5,Y
FA4C: 04 05          LSR    $2D
...
FA62: EC 01          LDD    ,--X
FA64: 4C             INCA
FA65: 32 92          LEAS   -$10,X
FA67: 7D D2 48       TST    $FA60
FA6A: 72 EE 68       XNC    $6640
FA6D: 97 36          STA    $BE
FA6F: E6 94          LDB    [A,Y]
FA71: 2A 7D          BPL    $FA72
FA73: 78 4E D8       ASL    $6CFA
FA76: F3 E2 57       ADDD   $607F
FA79: 56             RORB
FA7A: FF FE 78       STU    $7650
FA7D: D7 72          STB    $FA
FA7F: FF D8 5E       STU    $FA7C
FA82: A2 78          SBCA   [F,S]
FA84: D9 21          ADCB   $03
FA86: 71 C2 D7       NEG    $40FF
FA89: D6 7F          LDB    $F7
FA8B: E6 28          LDB    $0,X
FA8D: D6 77          LDB    $FF
FA8F: E6 D5          LDB    [E,S]
FA91: 62 74          XNC    [A,S]
FA93: 7C 4C 4C       INC    $6E6E
FA96: 82 7C          SBCA   #$FE
FA98: DE 46          LDU    $6E
FA9A: E6 C8          LDB    $0,U
FA9C: 75 74 DD       LSR    $5C55
FA9F: DC 62          LDD    $40
FAA1: 7B DA D3       XDEC   $5851
FAA4: 72 D8 43       XNC    $FAC1
FAA7: 78 EC D2       ASL    $C4FA
FAAA: 4F             CLRA
FAAB: 72 E2 D2       XNC    $CAFA
FAAE: 45             LSRA
FAAF: 72 F2 D8       XNC    $D0FA
FAB2: 51             NEGB
FAB3: 78 F4 D8       ASL    $D6FA
FAB6: 5B             XDECB
FAB7: 78 F4 D2       ASL    $DCFA
FABA: 57             ASRB
FABB: 72 CA D2       XNC    $E2FA
FABE: 6D 72          TST    [F,S]
FAC0: CA 42          ORB    #$60
FAC2: 58             ASLB
FAC3: 50             NEGB
FAC4: 42             XNCA
FAC5: F9 51 E2       ADCB   $D360
FAC8: F1 F9 E8       CMPB   $D160
FACB: 54             LSRB
FACC: FC 48 40       LDD    $60C8
FACF: 48             ASLA
FAD0: 42             XNCA
FAD1: FF 57 E2       STU    $D560
FAD4: FA F2 E2       ORB    $D060
FAD7: 48             ASLA
FAD8: EA 48          ORB    $0,S
FADA: 43             COMA
FADB: 4B             XDECA
FADC: 48             ASLA
FADD: E1 49          CMPB   ,U++
FADF: E8 EE E6       EORB   $FAA6,PCR
FAE2: E2 4F E7 42    SBCB   $C046,PCR
FAE6: 4C             INCA
FAE7: 44             LSRA
FAE8: 48             ASLA
FAE9: E7 4F          STB    E,U
...
FAEF: 91 3D          CMPA   $1F
FAF1: 07 AE          ASR    $2C
FAF3: B0 1A 1C       SUBA   $383E
FAF6: C6 C8          LDB    #$4A
FAF8: 78 7E D4       ASL    $565C
FAFB: EA 4F          ORB    $7,S
FAFD: 45             LSRA
FAFE: FB F0 5C       ADDB   $787E
FB01: A1 0A 0C       CMPA   -$72,X
FB04: B1 BA 1F       CMPA   $989D
FB07: 20 8F          BRA    $FAB0
FB09: 83 38 3C       SUBD   #$B0B4
FB0C: 91 95          CMPA   $BD
FB0E: 49             ROLA
FB0F: 4D             TSTA
FB10: EB EF 52 56    ADDB   $CBE8,PCR
FB14: F5 F9 5C       BITB   $DBDE
FB17: 63 CC          COM    ,S
FB19: CF 61 64       XSTU   #$E9EC
FB1C: C6 D8          LDB    #$F0
FB1E: 7A 7C D4       DEC    $F4F6
FB21: D5 7B          BITB   $F9
FB23: 78 D9 DE       ASL    $FBFC
FB26: 7F 7C D6       CLR    $FEFE
FB29: D7 77          STB    $FF
FB2B: 77 18 E8       ASR    $30C0
FB2E: BE 88 1A       LDX    >$0038
FB31: 4E             XCLRA
FB32: 78 43 12       ASL    $C130
FB35: EA B4          ORB    -$A,Y
FB37: 8A 10          ORA    #$38
FB39: 54             LSRB
FB3A: 72 4C 18       XNC    $C430
FB3D: F8 BE D8       EORB   $3650
FB40: 62 7E          XNC    -$4,U
FB42: 78 45 12       ASL    $C730
FB45: FA B4 DA       ORB    $3658
FB48: 68 A4 72       ASL    $FB45,PCR
FB4B: 42             XNCA
FB4C: 18             X18
FB4D: C8 BE          EORB   #$36
FB4F: E8 6A          EORB   $8,U
FB51: 46             RORA
FB52: 78 4F 12       ASL    $CD30
FB55: CA B4          ORB    #$36
FB57: EA 60          ORB    $8,U
FB59: 5C             INCB
FB5A: 72 58 18       XNC    $D030
FB5D: D8 BE          EORB   $36
FB5F: F8 6A A6       EORB   $4884
FB62: 78 51 27       ASL    $D305
FB65: 06 4F          ROR    $CD
FB67: 87 0D          XSTA   #$25
FB69: 25 81          BCS    $FB74
FB6B: AD 61          JSR    $9,U
FB6D: 25 AD          BCS    $FB94
FB6F: 01 2F          NEG    dsw2_copy_0d
FB71: 07 4B          ASR    $C9
FB73: 8F 04 2B       XSTX   #$2609
FB76: 82 02          SBCA   #$80
FB78: 17 A8 B4       LBSR   $7BB7
FB7B: 08 14          ASL    $3C
FB7D: A8 B4          EORA   -$4,Y
FB7F: 08 61          ASL    $43
FB81: A2 BC          SBCA   -$2,Y
...
FCAF: 88 12          EORA   #$30
FCB1: 22 B2          BHI    $FCE3
FCB3: B6 22 16       LDA    >$0034
FCB6: 84 B6          ANDA   #$34
FCB8: 24 1C          BCC    $FCEE
FCBA: 9A 74          ORA    $FC
FCBC: 41             NEGA
FCBD: D4 FB          ANDB   $73
FCBF: 74 5F 2C       LSR    $7D0E
FCC2: A3 8B          SUBD   $9,X
FCC4: 2C 03          BGE    $FCE7
FCC6: CB 8C          ADDB   #$0E
FCC8: 09 A1          ROL    $89
...
FCE1: A2 D4          SBCA   -$A,U
FCE3: 02 74          XNC    $56
FCE5: B2 CF 02       SBCA   $4D80
FCE8: 7F 28 9B       CLR    >$0013
FCEB: 88 37          EORA   #$1F
FCED: 28 95          BVC    $FD0C
FCEF: 88 3F          EORA   #$1D
FCF1: 22 97          BHI    $FD08
...
FCFD: 28 97          BVC    $FD1E
FCFF: 88 3C          EORA   #$1E
FD01: B2 D5 02       SBCA   $5780
FD04: 7A A2 DB       DEC    $8059
FD07: 02 71          XNC    $59
FD09: A8 D1          EORA   -$7,U
FD0B: 08 71          ASL    $59
FD0D: A8 D1          EORA   -$7,U
...
FD19: A8 D1          EORA   -$7,U
FD1B: 08 71          ASL    $59
FD1D: B8 D0 08       EORA   $5880
FD20: 6F A2          CLR    ,X+
FD22: D4 02          ANDB   $80
FD24: 74 A2 D4       LSR    $8056
FD27: 02 7E          XNC    $56
FD29: A8 DE          EORA   -$A,U
FD2B: 08 7E          ASL    $56
FD2D: A8 DE          EORA   -$A,U
...
FD35: A2 D4          SBCA   -$A,U
FD37: 02 7E          XNC    $56
FD39: B8 C5 08       EORA   $4D80
FD3C: 7F 29 9B       CLR    $0113
FD3F: 89 3D          ADCA   #$1F
FD41: 23 9F          BLS    $FD60
FD43: 83 3F 23       SUBD   #$1D01
FD46: 97 83          STA    $01
FD48: 36 29          PSHU   CC
FD4A: 9C 89          CMPX   $01
FD4C: 39             RTS
...
FD4F: 89 3B          ADCA   #$19
FD51: 23 9D          BLS    $FD72
FD53: 83 3C B2       SUBD   #$1E90
FD56: D5 02          BITB   $80
FD58: 70 A8 D1       NEG    $8059
FD5B: 08 71          ASL    $59
FD5D: A8 D1          EORA   -$7,U
FD5F: 08 7B          ASL    $59
FD61: A2 DB          SBCA   -$7,U
...
FD6D: A8 D1          EORA   -$7,U
FD6F: 08 7B          ASL    $59
FD71: B2 DA 02       SBCA   $5880
FD74: 6F A2          CLR    ,X+
FD76: D4 02          ANDB   $80
FD78: 7E A8 DE       JMP    $8056
FD7B: 08 7E          ASL    $56
FD7D: A8 DE          EORA   -$A,U
FD7F: 08 74          ASL    $56
FD81: A2 D4          SBCA   -$A,U
...
FD89: A8 DE          EORA   -$A,U
FD8B: 08 7E          ASL    $56
FD8D: B8 C5 08       EORA   $4D80
FD90: 75 21 91       LSR    $0313
FD93: 81 3D          CMPA   #$1F
FD95: 21 9F          BRN    $FDB4
FD97: 81 35          CMPA   #$1D
FD99: 2B 9D          BMI    $FDB0
...
FDA5: 21 9D          BRN    $FDC6
FDA7: 81 36          CMPA   #$1E
FDA9: B8 DF 08       EORA   $5780
FDAC: 70 A8 D1       NEG    $8059
FDAF: 08 7B          ASL    $59
FDB1: A2 DB          SBCA   -$7,U
FDB3: 02 7B          XNC    $59
FDB5: A2 DB          SBCA   -$7,U
...
FDC1: A2 DB          SBCA   -$7,U
FDC3: 02 7B          XNC    $59
FDC5: B2 DA 02       SBCA   $5880
FDC8: 65 A8          LSR    ,X+
FDCA: DE 08          LDU    $80
FDCC: 7E A8 DE       JMP    $8056
FDCF: 08 74          ASL    $56
FDD1: A2 D4          SBCA   -$A,U
FDD3: 02 74          XNC    $56
FDD5: A2 D4          SBCA   -$A,U
...
FDDD: A8 DE          EORA   -$A,U
FDDF: 08 74          ASL    $56
FDE1: B2 CF 02       SBCA   $4D80
FDE4: 75 28 91       LSR    $0A13
FDE7: 88 37          EORA   #$1F
FDE9: 22 95          BHI    $FE08
FDEB: 82 35          SBCA   #$1D
FDED: 22 9D          BHI    $FE04
...
FDF9: 22 97          BHI    $FE1A
FDFB: 82 36          SBCA   #$1E
FDFD: B8 DF 08       EORA   $5780
FE00: 7A A2 DB       DEC    $8059
FE03: 02 7B          XNC    $59
FE05: A2 DB          SBCA   -$7,U
FE07: 02 71          XNC    $59
FE09: A8 D1          EORA   -$7,U
...
FE15: A2 DB          SBCA   -$7,U
FE17: 02 71          XNC    $59
FE19: B8 D0 74       EORA   $58FC
FE1C: E3 D5 97 75    ADDD   [$11E1D,PCR]
FE20: 51             NEGB
FE21: DF 45          STU    $C7
FE23: F2 50 51       SBCB   $7273
FE26: F6 B3 18       LDB    $3130
FE29: 8B E5          ADDA   #$6D
FE2B: E0 58          SUBB   -$10,S
FE2D: 8B F4          ADDA   #$7C
FE2F: E0 53          SUBB   -$F,S
FE31: B7 EF C2       STA    $6D40
FE34: DE B7          LDU    $95
FE36: FE C2 D5       LDU    $40FD
FE39: 28 B9          BVC    $FE6C
FE3B: C8 5B          EORB   #$73
FE3D: 05 E0          LSR    $68
FE3F: FA 51 1E       ORB    $733C
FE42: EA F3          ORB    -$F,S
FE44: 47             ASRA
FE45: 0F C2          CLR    $40
FE47: 7E 4D 14       JMP    $653C
FE4A: C8 75          EORB   #$FD
FE4C: 28 19          BVC    $FE7F
FE4E: D8 E3          EORB   $6B
FE50: 97 4A          STA    $68
FE52: F1 E9 E6       CMPB   $6BC4
FE55: 4A             DECA
FE56: F3 DF 9D       ADDD   $5DB5
FE59: 68 74 D5       ASL    [$FEB9,PCR]
FE5C: EC 68          LDD    $0,U
FE5E: 75 88 13       LSR    >$0031
FE61: 02 D1          XNC    $53
FE63: F5 62 6C       BITB   $404E
FE66: BD DA 68       JSR    $5840
FE69: 6E B3          JMP    -$5,Y
FE6B: 10 68 6F       ASL    $7,U
FE6E: B4 FC 42       ANDA   $7460
FE71: 66 82          ROR    $0,X
FE73: 4E             XCLRA
FE74: C8 EE          EORB   #$CC
FE76: 73 4E D6       COM    $CCFE
FE79: E5 98          BITB   -$10,X
FE7B: 45             LSRA
FE7C: 6C E5 E5 45    INC    $16C4D,PCR
FE80: AD 32          JSR    -$10,X
FE82: 92 A3          SBCA   $21
FE84: 07 33          ASR    $11
FE86: 9E 9B          LDX    $19
...
FE8D: 0C 98          INC    $10
FE8F: 98 32          EORA   $10
FE91: 32 92          LEAS   -$10,X
FE93: 92 23          SBCA   $01
FE95: 02 92          XNC    $10
FE97: A1 0F          CMPA   $7,Y
FE99: 01 9D          NEG    $15
FE9B: AB 36          ADDA   -$2,X
FE9D: 37 9B          PULU   CC,A,X
FE9F: AB 6A          ADDA   $8,U
FEA1: 27 A7          BEQ    $FEC8
FEA3: 8F 21 04       XSTX   #$0326
FEA6: 08 80          ASL    $02
FEA8: 0E BB          JMP    $93
FEAA: 88 08          EORA   #$80
FEAC: F8 A8 59       EORB   $80D1
FEAF: 88 32          EORA   #$10
FEB1: 22 92          BHI    $FEC3
FEB3: 02 F2          XNC    $D0
FEB5: A2 53          SBCA   [,U++]
...
FEF5: 3D             MUL
FEF6: A6 9B          LDA    -$7,X
FEF8: 36 3F          PSHU   X,D,CC
FEFA: A8 97          EORA   -$1,X
FEFC: 34 3D          PSHS   X,B,CC
FEFE: 98 AE          EORA   $26
FF00: 33 07          LEAU   $5,Y
FF02: 9E A6          LDX    $24
FF04: 23 22          BLS    $FF06
FF06: 82 9F          SBCA   #$1D
FF08: 38 3E          XANDCC #$16
FF0A: AA 9D          ORA    -$B,X
FF0C: 3D             MUL
FF0D: 38 AB          XANDCC #$23
FF0F: AC 0B          CMPX   $9,Y
FF11: 3E             XRES
FF12: 97 A5          STA    $27
FF14: 37 3B          PULU   CC,DP,X
FF16: 95 9A          BITA   $18
FF18: 0C 38          INC    $10
FF1A: 94 91          ANDA   $19
FF1C: 3E             XRES
...
FF25: 37 A0          PULU   A,Y
FF27: AB 34          ADDA   -$4,X
FF29: 37 96          PULU   D,DP,X
FF2B: 9F 38          STX    $10
FF2D: 30 97          LEAX   -$1,X
FF2F: AA 01          ORA    $3,Y
FF31: 37 83          PULU   CC
FF33: A2 32          SBCA   -$10,X
FF35: 01 A5          NEG    $27
FF37: A7 08          STA    $0,Y
FF39: 38 98          XANDCC #$10
FF3B: AB 3D          ADDA   -$B,X
FF3D: 0C 98          INC    $10
FF3F: 9C 3D          CMPX   $1F
FF41: 05 9C          LSR    $1E
...
FF4B: 4C             INCA
FF4C: 22 0A          BHI    $FF70
FF4E: CC 87 00       LDD    #$0F22
FF51: E6 8C          LDB    $E,X
FF53: A1 66          CMPA   $4,U
FF55: 25 A1          BCS    $FF7A
FF57: 46             RORA
FF58: 22 0C          BHI    $FF7E
FF5A: CC 8D 0D       LDD    #$0525
FF5D: 25 84          BCS    $FF6B
FF5F: AE A9          LDX    D,X
FF61: 22 82          BHI    $FF63
FF63: 82 A8          SBCA   #$8A
...
FF89: 09 52          ROL    $DA
FF8B: 8D 0A          BSR    $FFAF
FF8D: 71 8F AA       NEG    $0722
FF90: F5 27 A1       BITB   $0523
FF93: DB 26          ADDB   $04
FF95: 01 58          NEG    $DA
FF97: 87 0C          XSTA   #$24
FF99: 71 88 A8       NEG    >$0020
FF9C: 0D 0B          TST    $23
FF9E: 90 98          SUBA   $10
FFA0: 01 37          NEG    $15
FFA2: A0 A4          SUBA   $6,Y
...
FFAD: 28 A9          BVC    $FFD0
FFAF: D1 03          CMPB   $21
FFB1: 78 A3 DE       ASL    $215C
FFB4: 03 7F          COM    $5D
FFB6: A3 58          SUBD   [F,U]
FFB8: 09 F3          ROL    $DB
FFBA: A9 54 09       ADCA   [$FFDE,PCR]
FFBD: F5 AA D1       BITB   $2259
FFC0: 00 78          NEG    $5A
FFC2: A0 DE          SUBA   -$4,U
FFC4: 00 7F          NEG    $5D
FFC6: A0 55          SUBA   [E,U]
...
FFCA: AA 52          ORA    [F,U]
FFCC: 0A F4          DEC    $DC
FFCE: AA 55 01 F8    ORA    [$123AC,PCR]
FFD2: A1 59          CMPA   [D,U]
FFD4: 01 FE          NEG    $DC
FFD6: A1 5F 0C 71    CMPA   [$12433,PCR]
FFDA: AC D2          CMPX   -$6,U
FFDC: 0C 74          INC    $5C
FFDE: AC D5          CMPX   -$3,U
FFE0: 9D E2          JSR    $C0
...
FFEB: 40             NEGA
FFEC: E1 E2          CMPB   F,U
FFEE: 77 77 DD       ASR    $FFFF
FFF1: DD 7D          STD    $FF
FFF3: 7D DD DD       TST    $FFFF
FFF6: 7D 7D 6C       TST    $FF44
FFF9: DD 77          STD    $FF
FFFB: 77 D7 D7       ASR    $FFFF
FFFE: C8 88          EORB   #$00
