...
{0xb1,0xac,0XA0,0xA4,0x11E,0xa2,0xB4,0xBE,0x11c,0x1B0,0x193,0x152,0x1A,0x8A,0x1B2,0x1c,0x14A,0x17E,0x1B8,0x1BA,0X150,0x188,0x180,0x111,
...
group_sprite_pairs = player_sprite_pairs | {0x168,0x170,0x17A,0x160,0x146,0x14E,0x1A8} |sr2(0x2A,0x30)
...
"""
    rval = ({0x31,0x1A1,0x1A3,0x1A4,0x1A5,0x1A6,0x1E6,0x1EE,0X138,0X1AC,0X110,0X130,0X124,0X12C,0X13C,0X134,0X113,0x103,0x1AE,0x145,0x111} | sr2(0x102,0x10A)|
