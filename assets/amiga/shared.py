...
def get_sprite_names():
    ...
    rval[0x1E6] = "gun"
    rval[0x6C] = "referee"
    rval |= {k:"girl" for k in range(0x1C0,0x1DE)}
    rval[0x6D] = "referee"
    rval[0x1EE] = "go"
    rval[0x27] = "mark"
    rval[0x16A] = "points"
...
"""
    rval = ({0X25,0X26,0X28,  # mole
    0x31,0x56,0x5E,0x42,0x4A,0x1A1,0x1A3,0x1A4,0x1A5,0x1A6,0x1E6,0x1EE,0X138,0X1AC,0X110,0X130,0X124,0X12C,0X13C,
